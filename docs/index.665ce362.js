 ...
 */function tt(){var t=[];function e(n,r){return t.push(n+" ")>i.cacheLength&&delete e[t.shift()],e[n+" "]=r}return e}/**
...
for(i in a=o.expand(a),delete t[n],a)(i in t)||(t[i]=a[i],e[i]=r);else e[n]=r}(c,h.opts.specialEasing);a<o;a++)if(n=en.prefilters[a].call(h,t,c,h.opts))return g(n.stop)&&(S._queueHooks(h.elem,h.opts.queue).stop=n.stop.bind(n)),n;return S.map(c,ei,h),g(h.opts.start)&&h.opts.start.call(t,h),// Attach callbacks from options
h.progress(h.opts.progress).done(h.opts.done,h.opts.complete).fail(h.opts.fail).always(h.opts.always),S.fx.timer(S.extend(l,{elem:t,anim:h,queue:h.opts.queue})),h}S.Animation=S.extend(en,{tweeners:{"*":[function(t,e){var i=this.createTween(t,e);return tg(i.elem,t,th.exec(e),i),i}]},tweener:function(t,e){g(t)?(e=t,t=["*"]):t=t.match(V);for(var i,n=0,r=t.length;n<r;n++)i=t[n],en.tweeners[i]=en.tweeners[i]||[],en.tweeners[i].unshift(e)},prefilters:[function(t,e,i){var n,r,a,o,s,l,h,c,u="width"in e||"height"in e,d=this,f={},p=t.style,g=t.nodeType&&tp(t),m=tn.get(t,"fxshow");// Detect show/hide animations
...
var e=en(this,S.extend({},t),a);// Empty animations, or finishing resolves immediately
...
S.fn.delay=function(e,i){return e=S.fx&&S.fx.speeds[e]||e,i=i||"fx",this.queue(i,function(i,n){var r=t.setTimeout(i,e);n.stop=function(){t.clearTimeout(r)}})},er=b.createElement("input"),ea=b.createElement("select").appendChild(b.createElement("option")),er.type="checkbox",// Support: Android <=4.3 only
// Default value for a checkbox should be "on"
p.checkOn=""!==er.value,// Support: IE <=11 only
// Must access selectedIndex to make default options select
p.optSelected=ea.selected,// Support: IE <=11 only
// An input loses its value after becoming a radio
(er=b.createElement("input")).value="t",er.type="radio",p.radioValue="t"===er.value;var er,ea,eo,es=S.expr.attrHandle;S.fn.extend({attr:function(t,e){return G(this,S.attr,t,e,arguments.length>1)},removeAttr:function(t){return this.each(function(){S.removeAttr(this,t)})}}),S.extend({attr:function(t,e,i){var n,r,a=t.nodeType;// Don't get/set attributes on text, comment and attribute nodes
if(3!==a&&8!==a&&2!==a){// Fallback to prop when attributes are not supported
if(void 0===t.getAttribute)return S.prop(t,e,i);if(1===a&&S.isXMLDoc(t)||(r=S.attrHooks[e.toLowerCase()]||(S.expr.match.bool.test(e)?eo:void 0)),void 0!==i){if(null===i){S.removeAttr(t,e);return}return r&&"set"in r&&void 0!==(n=r.set(t,i,e))?n:(t.setAttribute(e,i+""),i)}return r&&"get"in r&&null!==(n=r.get(t,e))?n:null==(n=S.find.attr(t,e))?void 0:n}},attrHooks:{type:{set:function(t,e){if(!p.radioValue&&"radio"===e&&C(t,"input")){var i=t.value;return t.setAttribute("type",e),i&&(t.value=i),e}}}},removeAttr:function(t,e){var i,n=0,// https://html.spec.whatwg.org/multipage/syntax.html#attributes-2
r=e&&e.match(V);if(r&&1===t.nodeType)for(;i=r[n++];)t.removeAttribute(i)}}),// Hooks for boolean attributes
eo={set:function(t,e,i){return!1===e?S.removeAttr(t,i):t.setAttribute(i,i),i}},S.each(S.expr.match.bool.source.match(/\w+/g),function(t,e){var i=es[e]||S.find.attr;es[e]=function(t,e,n){var r,a,o=e.toLowerCase();return n||(// Avoid an infinite loop by temporarily removing this function from the getter
a=es[o],es[o]=r,r=null!=i(t,e,n)?o:null,es[o]=a),r}});var el=/^(?:input|select|textarea|button)$/i,eh=/^(?:a|area)$/i;// Strip and collapse whitespace according to HTML spec
// https://infra.spec.whatwg.org/#strip-and-collapse-ascii-whitespace
function ec(t){return(t.match(V)||[]).join(" ")}function eu(t){return t.getAttribute&&t.getAttribute("class")||""}function ed(t){return Array.isArray(t)?t:"string"==typeof t&&t.match(V)||[]}S.fn.extend({prop:function(t,e){return G(this,S.prop,t,e,arguments.length>1)},removeProp:function(t){return this.each(function(){delete this[S.propFix[t]||t]})}}),S.extend({prop:function(t,e,i){var n,r,a=t.nodeType;// Don't get/set properties on text, comment and attribute nodes
...
var e=S.find.attr(t,"tabindex");return e?parseInt(e,10):el.test(t.nodeName)||eh.test(t.nodeName)&&t.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),p.optSelected||(S.propHooks.selected={get:function(t){/* eslint no-unused-expressions: "off" */var e=t.parentNode;return e&&e.parentNode&&e.parentNode.selectedIndex,null},set:function(t){/* eslint no-unused-expressions: "off" */var e=t.parentNode;e&&(e.selectedIndex,e.parentNode&&e.parentNode.selectedIndex)}}),S.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){S.propFix[this.toLowerCase()]=this}),S.fn.extend({addClass:function(t){var e,i,n,r,a,o;return g(t)?this.each(function(e){S(this).addClass(t.call(this,e,eu(this)))}):(e=ed(t)).length?this.each(function(){if(n=eu(this),i=1===this.nodeType&&" "+ec(n)+" "){for(a=0;a<e.length;a++)r=e[a],0>i.indexOf(" "+r+" ")&&(i+=r+" ");n!==// Only assign if different to avoid unneeded rendering.
(o=ec(i))&&this.setAttribute("class",o)}}):this},removeClass:function(t){var e,i,n,r,a,o;return g(t)?this.each(function(e){S(this).removeClass(t.call(this,e,eu(this)))}):arguments.length?(e=ed(t)).length?this.each(function(){if(n=eu(this),// This expression is here for better compressibility (see addClass)
i=1===this.nodeType&&" "+ec(n)+" "){for(a=0;a<e.length;a++)// Remove *all* instances
for(r=e[a];i.indexOf(" "+r+" ")>-1;)i=i.replace(" "+r+" "," ");n!==// Only assign if different to avoid unneeded rendering.
(o=ec(i))&&this.setAttribute("class",o)}}):this:this.attr("class","")},toggleClass:function(t,e){var i,n,r,a,o=typeof t,s="string"===o||Array.isArray(t);return g(t)?this.each(function(i){S(this).toggleClass(t.call(this,i,eu(this),e),e)}):"boolean"==typeof e&&s?e?this.addClass(t):this.removeClass(t):(i=ed(t),this.each(function(){if(s)for(r=0,// Toggle individual class names
a=S(this);r<i.length;r++)n=i[r],a.hasClass(n)?a.removeClass(n):a.addClass(n);else(void 0===t||"boolean"===o)&&((n=eu(this))&&tn.set(this,"__className__",n),this.setAttribute&&this.setAttribute("class",n||!1===t?"":tn.get(this,"__className__")||""))}))},hasClass:function(t){var e,i,n=0;for(e=" "+t+" ";i=this[n++];)if(1===i.nodeType&&(" "+ec(eu(i))+" ").indexOf(e)>-1)return!0;return!1}});var ef=/\r/g;S.fn.extend({val:function(t){var e,i,n,r=this[0];return arguments.length?(n=g(t),this.each(function(i){var r;1!==this.nodeType||(null==(r=n?t.call(this,i,S(this).val()):t)?r="":"number"==typeof r?r+="":Array.isArray(r)&&(r=S.map(r,function(t){return null==t?"":t+""})),(e=S.valHooks[this.type]||S.valHooks[this.nodeName.toLowerCase()])&&"set"in e&&void 0!==e.set(this,r,"value")||(this.value=r))})):r?(e=S.valHooks[r.type]||S.valHooks[r.nodeName.toLowerCase()])&&"get"in e&&void 0!==(i=e.get(r,"value"))?i:"string"==typeof(i=r.value)?i.replace(ef,""):null==i?"":i:void 0}}),S.extend({valHooks:{option:{get:function(t){var e=S.find.attr(t,"value");return null!=e?e:// option.text throws exceptions (trac-14686, trac-14858)
// Strip and collapse whitespace
// https://html.spec.whatwg.org/#strip-and-collapse-whitespace
ec(S.text(t))}},select:{get:function(t){var e,i,n,r=t.options,a=t.selectedIndex,o="select-one"===t.type,s=o?null:[],l=o?a+1:r.length;// Loop through all the selected options
...
var ep=t.location,eg={guid:Date.now()},em=/\?/;// Cross-browser xml parsing
S.parseXML=function(e){var i,n;if(!e||"string"!=typeof e)return null;// Support: IE 9 - 11 only
// IE throws on parseFromString with invalid input.
try{i=new t.DOMParser().parseFromString(e,"text/xml")}catch(t){}return n=i&&i.getElementsByTagName("parsererror")[0],(!i||n)&&S.error("Invalid XML: "+(n?S.map(n.childNodes,function(t){return t.textContent}).join("\n"):e)),i};var eb=/^(?:focusinfocus|focusoutblur)$/,ev=function(t){t.stopPropagation()};S.extend(S.event,{trigger:function(e,i,n,r){var a,o,s,l,h,c,d,f,p=[n||b],v=u.call(e,"type")?e.type:e,y=u.call(e,"namespace")?e.namespace.split("."):[];// Don't do events on text and comment nodes
if(o=f=s=n=n||b,!(3===n.nodeType||8===n.nodeType||eb.test(v+S.event.triggered))&&(v.indexOf(".")>-1&&(v=// Namespaced trigger; create a regexp to match event type in handle()
...
if(!r&&!d.noBubble&&!m(n)){for(l=d.delegateType||v,eb.test(l+v)||(o=o.parentNode);o;o=o.parentNode)p.push(o),s=o;s===(n.ownerDocument||b)&&p.push(s.defaultView||s.parentWindow||t)}for(// Fire handlers on the event path
...
S.event.triggered=v,e.isPropagationStopped()&&f.addEventListener(v,ev),n[v](),e.isPropagationStopped()&&f.removeEventListener(v,ev),S.event.triggered=void 0,s&&(n[h]=s)),e.result}},// Piggyback on a donor event to simulate a different one
// Used only for `focus(in | out)` events
simulate:function(t,e,i){var n=S.extend(new S.Event,i,{type:t,isSimulated:!0});S.event.trigger(n,null,e)}}),S.fn.extend({trigger:function(t,e){return this.each(function(){S.event.trigger(t,e,this)})},triggerHandler:function(t,e){var i=this[0];if(i)return S.event.trigger(t,e,i,!0)}});var ey=/\[\]$/,ex=/\r?\n/g,e_=/^(?:submit|button|image|reset|file)$/i,ew=/^(?:input|select|textarea|keygen)/i;// Serialize an array of form elements or a set of
...
for(i in t)!function t(e,i,n,r){var a;if(Array.isArray(i))S.each(i,function(i,a){n||ey.test(e)?r(e,a):t(e+"["+("object"==typeof a&&null!=a?i:"")+"]",a,n,r)});else if(n||"object"!==x(i))r(e,i);else for(a in i)t(e+"["+a+"]",i[a],n,r)}(i,t[i],e,r);// Return the resulting serialization
...
return this.name&&!S(this).is(":disabled")&&ew.test(this.nodeName)&&!e_.test(t)&&(this.checked||!tv.test(t))}).map(function(t,e){var i=S(this).val();return null==i?null:Array.isArray(i)?S.map(i,function(t){return{name:e.name,value:t.replace(ex,"\r\n")}}):{name:e.name,value:i.replace(ex,"\r\n")}}).get()}});var eS=/%20/g,eD=/#.*$/,eC=/([?&])_=[^&]*/,eT=/^(.*?):[ \t]*([^\r\n]*)$/mg,ek=/^(?:GET|HEAD)$/,eM=/^\/\//,/* Prefilters
	 ...
	 */eA={},/* Transports bindings
	 * 1) key is the dataType
	 * 2) the catchall symbol "*" can be used
	 * 3) selection will start with transport dataType and THEN go to "*" if needed
	 */eP={},eL="*/".concat("*"),eE=b.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
function eI(t){// dataTypeExpression is optional and defaults to "*"
...
function eO(t,e,i,n){var r={},a=t===eP;function o(s){var l;return r[s]=!0,S.each(t[s]||[],function(t,s){var h=s(e,i,n);return"string"!=typeof h||a||r[h]?a?!(l=h):void 0:(e.dataTypes.unshift(h),o(h),!1)}),l}return o(e.dataTypes[0])||!r["*"]&&o("*")}// A special extend for ajax options
// that takes "flat" options (not to be deep extended)
// Fixes trac-9887
function eR(t,e){var i,n,r=S.ajaxSettings.flatOptions||{};for(i in e)void 0!==e[i]&&((r[i]?t:n||(n={}))[i]=e[i]);return n&&S.extend(!0,t,n),t}eE.href=ep.href,S.extend({// Counter for holding the number of active queries
active:0,// Last-Modified header cache for next request
lastModified:{},etag:{},ajaxSettings:{url:ep.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(ep.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",/*
		timeout: 0,
		data: null,
		dataType: null,
		username: null,
		...
		traditional: false,
		headers: {},
		*/accepts:{"*":eL,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},// Data converters
...
ajaxSetup:function(t,e){return e?eR(eR(t,S.ajaxSettings),e):eR(S.ajaxSettings,t)},ajaxPrefilter:eI(eA),ajaxTransport:eI(eP),// Main method
...
getResponseHeader:function(t){var e;if(h){if(!o)for(o={};e=eT.exec(a);)o[e[1].toLowerCase()+" "]=(o[e[1].toLowerCase()+" "]||[]).concat(e[2]);e=o[t.toLowerCase()+" "]}return null==e?null:e.join(", ")},// Raw string
...
f.url=((e||f.url||ep.href)+"").replace(eM,ep.protocol+"//"),// Alias method option to type as per ticket trac-12004
...
l.href=l.href,f.crossDomain=eE.protocol+"//"+eE.host!=l.protocol+"//"+l.host}catch(t){// If there is an error parsing the URL, assume it is crossDomain,
...
eO(eA,f,i,D),h)return D;// Check for headers option
...
f.hasContent=!ek.test(f.type),// Save the URL in case we're toying with the If-Modified-Since
// and/or If-None-Match header later on
// Remove hash to simplify url manipulation
r=f.url.replace(eD,""),f.hasContent?f.data&&f.processData&&0===(f.contentType||"").indexOf("application/x-www-form-urlencoded")&&(f.data=f.data.replace(eS,"+")):(// Remember the hash so we can put it back
d=f.url.slice(r.length),f.data&&(f.processData||"string"==typeof f.data)&&(r+=(em.test(r)?"&":"?")+f.data,// trac-9682: remove data so that it's not used in an eventual retry
delete f.data),!1===f.cache&&(r=r.replace(eC,"$1"),d=(em.test(r)?"&":"?")+"_="+eg.guid+++d),// Put hash and anti-cache on the URL that will be requested (gh-1732)
...
D.setRequestHeader("Accept",f.dataTypes[0]&&f.accepts[f.dataTypes[0]]?f.accepts[f.dataTypes[0]]+("*"!==f.dataTypes[0]?", "+eL+"; q=0.01":""):f.accepts["*"]),f.headers)D.setRequestHeader(u,f.headers[u]);// Allow custom headers/mimetypes and early abort
...
n=eO(eP,f,i,D)){// If request was aborted inside ajaxSend, stop there
...
i=function(t){return function(){i&&(i=n=s.onload=s.onerror=s.onabort=s.ontimeout=s.onreadystatechange=null,"abort"===t?s.abort():"error"===t?"number"!=typeof s.status?a(0,"error"):a(s.status,s.statusText):a(eF[s.status]||s.status,s.statusText,"text"!==// IE9 has no XHR2 but throws on binary (trac-11426)
...
b.head.appendChild(e[0])},abort:function(){i&&i()}}}});var eN=[],eH=/(=)\?(?=&|$)|\?\?/;// Default jsonp settings
S.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var t=eN.pop()||S.expando+"_"+eg.guid++;return this[t]=!0,t}}),// Detect, normalize options and install callbacks for jsonp requests
S.ajaxPrefilter("json jsonp",function(e,i,n){var r,a,o,s=!1!==e.jsonp&&(eH.test(e.url)?"url":"string"==typeof e.data&&0===(e.contentType||"").indexOf("application/x-www-form-urlencoded")&&eH.test(e.data)&&"data");// Handle iff the expected data type is "jsonp" or we have a parameter to set
if(s||"jsonp"===e.dataTypes[0])// Delegate to script
return(// Get callback name, remembering preexisting value associated with it
r=e.jsonpCallback=g(e.jsonpCallback)?e.jsonpCallback():e.jsonpCallback,s?e[s]=e[s].replace(eH,"$1"+r):!1!==e.jsonp&&(e.url+=(em.test(e.url)?"&":"?")+e.jsonp+"="+r),// Use data converter to retrieve json after script execution
...
eN.push(r)),o&&g(a)&&a(o[0]),o=a=void 0}),"script")}),// Support: Safari 8 only
 ...
 */S.fn.load=function(t,e,i){var n,r,a,o=this,s=t.indexOf(" ");return s>-1&&(n=ec(t.slice(s)),t=t.slice(0,s)),g(e)?(// We assume that it's the callback
...
!isNaN(t-parseFloat(t))},S.trim=function(t){return null==t?"":(t+"").replace(eW,"$1")},"function"==typeof define&&define.amd&&define("jquery",[],function(){return S});var eB=t.jQuery,ez=t.$;return S.noConflict=function(e){return t.$===S&&(t.$=ez),e&&t.jQuery===S&&(t.jQuery=eB),S},void 0===e&&(t.jQuery=t.$=S),S},"object"==typeof rJ?// is present, execute the factory and get jQuery.
// For environments that do not have a `window` with a `document`
// (such as Node.js), expose a factory as module.exports.
// This accentuates the need for the creation of a real `window`.
// e.g. var jQuery = require("jquery")(window);
// See ticket trac-14549 for more info.
rJ=t0.document?t1(t0,!0):function(t){if(!t.document)throw Error("jQuery requires a window with a document");return t1(t)}:t1(t0);/*! DataTables 1.13.5
 * ©2008-2023 SpryMedia Ltd - datatables.net/license
 */// DataTables code uses $ internally, but we want to be able to
// reassign $ with the `use` method, so it is a regular var.
var rG=/*@__PURE__*/a(rJ),rK=function(t,e){// Check if called with a window or jQuery object for DOM less applications
// This is for backwards compatibility
if(rK.factory(t,e))return rK;// When creating with `new`, create a new DataTable, returning the API instance
if(this instanceof rK)return rG(t).DataTable(e);e=t,/**
	 ...
	 */this.api=function(t){return new t5(t?oE(this[t2.iApiIndex]):this)},/**
	 ...
	 *      giCount++;
	 *    }
	 */this.fnAddData=function(t,e){var i=this.api(!0),n=Array.isArray(t)&&(Array.isArray(t[0])||rG.isPlainObject(t[0]))?i.rows.add(t):i.row.add(t);return(void 0===e||e)&&i.draw(),n.flatten().toArray()},/**
	 ...
	 *      } );
	 *    } );
	 */this.fnAdjustColumnSizing=function(t){var e=this.api(!0).columns.adjust(),i=e.settings()[0],n=i.oScroll;void 0===t||t?e.draw(!1):(""!==n.sX||""!==n.sY)&&/* If not redrawing, but scrolling, we want to apply the new column sizes anyway */of(i)},/**
...
this.api(!0).draw(t)},/**
	 ...
	 *    } );
	 */this.fnSettings=function(){return oE(this[t2.iApiIndex])},/**
...
for(var a in n&&(e={}),this.oApi=this.internal=t2.internal,rK.ext.internal)a&&(this[a]=sf(a));return this.each(function(){var t,a,o=r>1?oR({},e,!0):e,s=0,l=this.getAttribute("id"),h=!1,c=rK.defaults,u=rG(this);/* Sanity check */if("table"!=this.nodeName.toLowerCase()){oI(null,0,"Non-table node initialisation ("+this.nodeName+")",2);return}/* Backwards compatibility for the defaults */ad(c),af(c.column),/* Convert the camel-case defaults to Hungarian */ah(c,c,!0),ah(c.column,c.column,!0),/* Setting up the initialisation object */ah(c,rG.extend(o,u.data()),!0);/* Check to see if we are re-initialising a table */var d=rK.settings;for(s=0,a=d.length;s<a;s++){var f=d[s];/* Base check on table node */if(f.nTable==this||f.nTHead&&f.nTHead.parentNode==this||f.nTFoot&&f.nTFoot.parentNode==this){var p=void 0!==o.bRetrieve?o.bRetrieve:c.bRetrieve,g=void 0!==o.bDestroy?o.bDestroy:c.bDestroy;if(n||p)return f.oInstance;if(g){f.oInstance.fnDestroy();break}oI(f,0,"Cannot reinitialise DataTable",3);return}/* If the element we are initialising has the same ID as a table which was previously
			 * initialised, but the table nodes don't match (from before) then we destroy the old
			 * instance by simply deleting it. This is under the assumption that the table has been
			 * destroyed by other methods. Anyone using non-id selectors will need to do this manually
			 */if(f.sTableId==this.id){d.splice(s,1);break}}(null===l||""===l)&&(l="DataTables_Table_"+rK.ext._unique++,this.id=l);/* Create the settings object for this table and set some of the default parameters */var m=rG.extend(!0,{},rK.models.oSettings,{sDestroyWidth:u[0].style.width,sInstance:l,sTableId:l});m.nTable=this,m.oApi=i.internal,m.oInit=o,d.push(m),// Need to add the instance after the instance after the settings object has been added
// to the settings array, so we can self reference the table instance if more than one
m.oInstance=1===i.length?i:u.dataTable(),// Backwards compatibility, before we apply all the defaults
ad(o),ac(o.oLanguage),o.aLengthMenu&&!o.iDisplayLength&&(o.iDisplayLength=Array.isArray(o.aLengthMenu[0])?o.aLengthMenu[0][0]:o.aLengthMenu[0]),// Apply the defaults and init options to make a single init object will all
// options defined from defaults and instance options.
o=oR(rG.extend(!0,{},c),o),// Map the initialisation options onto the settings object
oO(m.oFeatures,o,["bPaginate","bLengthChange","bFilter","bSort","bSortMulti","bInfo","bProcessing","bAutoWidth","bSortClasses","bServerSide","bDeferRender"]),oO(m,o,["asStripeClasses","ajax","fnServerData","fnFormatNumber","sServerMethod","aaSorting","aaSortingFixed","aLengthMenu","sPaginationType","sAjaxSource","sAjaxDataProp","iStateDuration","sDom","bSortCellsTop","iTabIndex","fnStateLoadCallback","fnStateSaveCallback","renderer","searchDelay","rowId",["iCookieDuration","iStateDuration"],["oSearch","oPreviousSearch"],["aoSearchCols","aoPreSearchCols"],["iDisplayLength","_iDisplayLength"]]),oO(m.oScroll,o,[["sScrollX","sX"],["sScrollXInner","sXInner"],["sScrollY","sY"],["bScrollCollapse","bCollapse"]]),oO(m.oLanguage,o,"fnInfoCallback"),/* Callback functions which are array driven */oj(m,"aoDrawCallback",o.fnDrawCallback,"user"),oj(m,"aoServerParams",o.fnServerParams,"user"),oj(m,"aoStateSaveParams",o.fnStateSaveParams,"user"),oj(m,"aoStateLoadParams",o.fnStateLoadParams,"user"),oj(m,"aoStateLoaded",o.fnStateLoaded,"user"),oj(m,"aoRowCallback",o.fnRowCallback,"user"),oj(m,"aoRowCreatedCallback",o.fnCreatedRow,"user"),oj(m,"aoHeaderCallback",o.fnHeaderCallback,"user"),oj(m,"aoFooterCallback",o.fnFooterCallback,"user"),oj(m,"aoInitComplete",o.fnInitComplete,"user"),oj(m,"aoPreDrawCallback",o.fnPreDrawCallback,"user"),m.rowIdFn=aE(o.rowId),/* Browser support detection */ap(m);var b=m.oClasses;if(rG.extend(b,rK.ext.classes,o.oClasses),u.addClass(b.sTable),void 0===m.iInitDisplayStart&&(/* Display start point, taking into account the save saving */m.iInitDisplayStart=o.iDisplayStart,m._iDisplayStart=o.iDisplayStart),null!==o.iDeferLoading){m.bDeferLoading=!0;var v=Array.isArray(o.iDeferLoading);m._iRecordsDisplay=v?o.iDeferLoading[0]:o.iDeferLoading,m._iRecordsTotal=v?o.iDeferLoading[1]:o.iDeferLoading}/* Language definitions */var y=m.oLanguage;rG.extend(!0,y,o.oLanguage),y.sUrl?(/* Get the language definitions from a file - because this Ajax call makes the language
			 * get async to the remainder of this function we use bInitHandedOff to indicate that
			 * _fnInitialise will be fired by the returned Ajax handler, rather than the constructor
			 */rG.ajax({dataType:"json",url:y.sUrl,success:function(t){ah(c.oLanguage,t),ac(t),rG.extend(!0,y,t,m.oInit.oLanguage),oN(m,null,"i18n",[m]),or(m)},error:function(){// Error occurred loading language file, continue on as best we can
or(m)}}),h=!0):oN(m,null,"i18n",[m]),null===o.asStripeClasses&&(m.asStripeClasses=[b.sStripeOdd,b.sStripeEven]);/* Remove row stripe classes if they are already on the table row */var x=m.asStripeClasses,_=u.children("tbody").find("tr").eq(0);-1!==rG.inArray(!0,rG.map(x,function(t,e){return _.hasClass(t)}))&&(rG("tbody tr",this).removeClass(x.join(" ")),m.asDestroyStripes=x.slice());/*
		 * Columns
		 * See if we should load columns automatically or use defined ones
		 */var w=[],S=this.getElementsByTagName("thead");/* If not given a column array, generate one with nulls */if(0!==S.length&&(aU(m.aoHeader,S[0]),w=aX(m)),null===o.aoColumns)for(s=0,t=[],a=w.length;s<a;s++)t.push(null);else t=o.aoColumns;/* Add the columns */for(s=0,a=t.length;s<a;s++)am(m,w?w[s]:null);/* HTML5 attribute detection - build an mData object automatically if the
		 * attributes are found
		 */if(/* Apply the column definitions */aD(m,o.aoColumnDefs,t,function(t,e){ab(m,t,e)}),_.length){var D=function(t,e){return null!==t.getAttribute("data-"+e)?e:null};rG(_[0]).children("th, td").each(function(t,e){var i=m.aoColumns[t];if(i||oI(m,0,"Incorrect column count",18),i.mData===t){var n=D(e,"sort")||D(e,"order"),r=D(e,"filter")||D(e,"search");(null!==n||null!==r)&&(i.mData={_:t+".display",sort:null!==n?t+".@data-"+n:void 0,type:null!==n?t+".@data-"+n:void 0,filter:null!==r?t+".@data-"+r:void 0},i._isArrayHost=!0,ab(m,t))}})}var C=m.oFeatures,T=function(){/*
			 * Sorting
...
if(void 0===o.aaSorting){var t=m.aaSorting;for(s=0,a=t.length;s<a;s++)t[s][1]=m.aoColumns[s].asSorting[0]}/* Do a first pass on the sorting classes (allows any size changes to be taken into
			 ...
			 */ok(m),C.bSort&&oj(m,"aoDrawCallback",function(){if(m.bSorted){var t=ow(m),e={};rG.each(t,function(t,i){e[i.src]=i.dir}),oN(m,null,"order",[m,t,e]),oD(m)}}),oj(m,"aoDrawCallback",function(){(m.bSorted||"ssp"===oB(m)||C.bDeferRender)&&ok(m)},"sc");/*
			 * Final init
			 * Cache the header, body and footer as required, creating them if needed
			 */// Work around for Webkit bug 83867 - store the caption-side before removing from doc
var e=u.children("caption").each(function(){this._captionSide=rG(this).css("caption-side")}),i=u.children("thead");0===i.length&&(i=rG("<thead/>").appendTo(u)),m.nTHead=i[0];var n=u.children("tbody");0===n.length&&(n=rG("<tbody/>").insertAfter(i)),m.nTBody=n[0];var r=u.children("tfoot");/* Check if there is data passing into the constructor */if(0===r.length&&e.length>0&&(""!==m.oScroll.sX||""!==m.oScroll.sY)&&// a tfoot element for the caption element to be appended to
(r=rG("<tfoot/>").appendTo(u)),0===r.length||0===r.children().length?u.addClass(b.sNoFooter):r.length>0&&(m.nTFoot=r[0],aU(m.aoFooter,m.nTFoot)),o.aaData)for(s=0;s<o.aaData.length;s++)aC(m,o.aaData[s]);else(m.bDeferLoading||"dom"==oB(m))&&/* Grab the data from the page - only do this when deferred loading or no Ajax
				 * source since there is no point in reading the DOM data if we are then going
				 * to replace it with Ajax data
				 */aT(m,rG(m.nTBody).children("tr"));/* Copy the data index array */m.aiDisplay=m.aiDisplayMaster.slice(),/* Initialisation complete - table can be drawn */m.bInitialised=!0,!1===h&&or(m)};/* Must be done after everything which can be overridden by the state saving! */oj(m,"aoDrawCallback",oA,"state_save"),o.bStateSave?(C.bStateSave=!0,oP(m,o,T)):T()}),i=null,this},rZ={},rQ=/[\r\n\u2028]/g,r0=/<.*?>/g,r1=/^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/,r2=RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)","g"),r5=/['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi,r3=function(t){return!t||!0===t||"-"===t},r4=function(t){var e=parseInt(t,10);return!isNaN(e)&&isFinite(t)?e:null},r8=function(t,e){return rZ[e]||(rZ[e]=RegExp(a4(e),"g")),"string"==typeof t&&"."!==e?t.replace(/\./g,"").replace(rZ[e],"."):t},r6=function(t,e,i){var n=typeof t,r="string"===n;return!!("number"===n||"bigint"===n||r3(t))||(e&&r&&(t=r8(t,e)),i&&r&&(t=t.replace(r5,"")),!isNaN(parseFloat(t))&&isFinite(t))},r9=function(t,e,i){return!!r3(t)||(r3(t)||"string"==typeof t)&&!!r6(an(t),e,i)||null},r7=function(t,e,i){var n=[],r=0,a=t.length;// Could have the test in the loop for slightly smaller code, but speed
// is essential here
if(void 0!==i)for(;r<a;r++)t[r]&&t[r][e]&&n.push(t[r][e][i]);else for(;r<a;r++)t[r]&&n.push(t[r][e]);return n},at=function(t,e,i,n){var r=[],a=0,o=e.length;// Could have the test in the loop for slightly smaller code, but speed
// is essential here
if(void 0!==n)for(;a<o;a++)t[e[a]][i]&&r.push(t[e[a]][i][n]);else for(;a<o;a++)r.push(t[e[a]][i]);return r},ae=function(t,e){var i,n=[];void 0===e?(e=0,i=t):(i=e,e=t);for(var r=e;r<i;r++)n.push(r);return n},ai=function(t){for(var e=[],i=0,n=t.length;i<n;i++)t[i]&&e.push(t[i]);return e},an=function(t){return t.replace(r0,"")// Complete tags
.replace(/<script/i,"");// Safety for incomplete script tag
},ar=function(t){if(t.length<2)return!0;for(var e=t.slice().sort(),i=e[0],n=1,r=e.length;n<r;n++){if(e[n]===i)return!1;i=e[n]}return!0},aa=function(t){if(ar(t))return t.slice();// A faster unique method is to use object keys to identify used values,
// but this doesn't work with arrays or objects, which we must also
// consider. See jsperf.com/compare-array-unique-versions/4 for more
// information.
var e,i,n,r=[],a=t.length,o=0;t:for(i=0;i<a;i++){for(n=0,e=t[i];n<o;n++)if(r[n]===e)continue t;r.push(e),o++}return r},ao=function(t,e){if(Array.isArray(e))for(var i=0;i<e.length;i++)ao(t,e[i]);else t.push(e);return t},as=function(t,e){return void 0===e&&(e=0),-1!==this.indexOf(t,e)};/**
 * Create a mapping object that allows camel case parameters to be looked up
 * for their Hungarian counterparts. The mapping is stored in a private
 * parameter called `_hungarianMap` which can be accessed on the source object.
 *  @param {object} o
 *  @memberof DataTable#oApi
 */function al(t){var e,i={};rG.each(t,function(n,r){(e=n.match(/^([^A-Z]+?)([A-Z])/))&&-1!=="a aa ai ao as b fn i m o s ".indexOf(e[1]+" ")&&(i[n.replace(e[0],e[2].toLowerCase())]=n,"o"===e[1]&&al(t[n]))}),t._hungarianMap=i}/**
 ...
 *    won't be.
 *  @memberof DataTable#oApi
 */function ah(t,e,i){var n;t._hungarianMap||al(t),rG.each(e,function(r,a){void 0!==(n=t._hungarianMap[r])&&(i||void 0===e[n])&&("o"===n.charAt(0)?(e[n]||(e[n]={}),rG.extend(!0,e[n],e[r]),ah(t[n],e[n],i)):e[n]=e[r])})}/**
 * Language compatibility - when certain options are given, and others aren't, we
 * need to duplicate the values over, in order to provide backwards compatibility
 * with older language files.
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function ac(t){// Note the use of the Hungarian notation for the parameters in this method as
// this is called after the mapping of camelCase to Hungarian
var e=rK.defaults.oLanguage,i=e.sDecimal;if(i&&sn(i),t){var n=t.sZeroRecords;!t.sEmptyTable&&n&&"No data available in table"===e.sEmptyTable&&oO(t,t,"sZeroRecords","sEmptyTable"),!t.sLoadingRecords&&n&&"Loading..."===e.sLoadingRecords&&oO(t,t,"sZeroRecords","sLoadingRecords"),t.sInfoThousands&&(t.sThousands=t.sInfoThousands);var r=t.sDecimal;r&&i!==r&&sn(r)}}Array.isArray||(Array.isArray=function(t){return"[object Array]"===Object.prototype.toString.call(t)}),Array.prototype.includes||(Array.prototype.includes=as),String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}),String.prototype.includes||(String.prototype.includes=as),/**
 ...
 */rK.util={/**
	 ...
	 */escapeRegex:function(t){return t.replace(r2,"\\$1")},/**
	 * Create a function that will write to a nested object or array
	 * @param {*} source JSON notation string
	 * @returns Write function
	 */set:function(t){if(rG.isPlainObject(t))/* Unlike get, only the underscore (global) option is used for for
			 * setting data since we don't know the type here. This is why an object
			 * option is not documented for `mData` (which is read/write), but it is
			 * for `mRender` which is read only.
			 */return rK.util.set(t._);if(null===t)return function(){};if("function"==typeof t)return function(e,i,n){t(e,"set",i,n)};if("string"!=typeof t||-1===t.indexOf(".")&&-1===t.indexOf("[")&&-1===t.indexOf("("))return function(e,i){e[t]=i};// Like the get, we need to get data from a nested object
var e=function(t,i,n){for(var r,a,o,s,l,h=aL(n),c=h[h.length-1],u=0,d=h.length-1;u<d;u++){// Protect against prototype pollution
...
r=h[u].match(aA),a=h[u].match(aP),r){// Traverse each entry in the array setting the properties requested
if(h[u]=h[u].replace(aA,""),t[h[u]]=[],// Get the remainder of the nested object to set so we can recurse
...
h[u]=h[u].replace(aP,""),t=t[h[u]](i)),(null===t[h[u]]||void 0===t[h[u]])&&(t[h[u]]={}),t=t[h[u]]}// Last item in the input - i.e, the actual set
c.match(aP)?t=t[c.replace(aP,"")](i):// and assign the value. If it isn't used, then we get the result we want anyway
t[c.replace(aA,"")]=i};return function(i,n){return e(i,n,t)}},/**
	 * Create a function that will read nested objects from arrays, based on JSON notation
	 * @param {*} source JSON notation string
	 * @returns Value read
	 */get:function(t){if(rG.isPlainObject(t)){// Build an object of get functions, and wrap them in a single call
var e={};return rG.each(t,function(t,i){i&&(e[t]=rK.util.get(i))}),function(t,i,n,r){var a=e[i]||e._;return void 0!==a?a(t,i,n,r):t}}if(null===t)return function(t){return t};if("function"==typeof t)return function(e,i,n,r){return t(e,i,n,r)};if("string"!=typeof t||-1===t.indexOf(".")&&-1===t.indexOf("[")&&-1===t.indexOf("("))return function(e,i){return e[t]};/* If there is a . in the source string then the data source is in a
			 * nested object so we loop over the data for each level to get the next
			 * level down. On each loop we test for undefined, and if found immediately
			 * return. This allows entire objects to be missing and sDefaultContent to
			 * be used if defined, rather than throwing an error
			 */var i=function(t,e,n){var r,a,o,s;if(""!==n)for(var l=aL(n),h=0,c=l.length;h<c;h++){if(// Check if we are dealing with special notation
r=l[h].match(aA),a=l[h].match(aP),r){// Traverse each entry in the array getting the properties requested
if(// Array notation
l[h]=l[h].replace(aA,""),""!==l[h]&&(t=t[l[h]]),o=[],// Get the remainder of the nested object to get
...
l[h]=l[h].replace(aP,""),t=t[l[h]]();continue}if(null===t||null===t[l[h]])return null;if(void 0===t||void 0===t[l[h]])return;t=t[l[h]]}return t};return function(e,n){return i(e,n,t)}}};/**
 * Map one parameter onto another
 *  @param {object} o Object to map
 *  @param {*} knew The new parameter name
 *  @param {*} old The old parameter name
 */var au=function(t,e,i){void 0!==t[e]&&(t[i]=t[e])};/**
 * Provide backwards compatibility for the main DT options. Note that the new
 * options are mapped onto the old parameters, so this is an external interface
 * change only.
 *  @param {object} init Object to map
 */function ad(t){au(t,"ordering","bSort"),au(t,"orderMulti","bSortMulti"),au(t,"orderClasses","bSortClasses"),au(t,"orderCellsTop","bSortCellsTop"),au(t,"order","aaSorting"),au(t,"orderFixed","aaSortingFixed"),au(t,"paging","bPaginate"),au(t,"pagingType","sPaginationType"),au(t,"pageLength","iDisplayLength"),au(t,"searching","bFilter"),"boolean"==typeof t.sScrollX&&(t.sScrollX=t.sScrollX?"100%":""),"boolean"==typeof t.scrollX&&(t.scrollX=t.scrollX?"100%":"");// Column search objects are in an array, so it needs to be converted
// element by element
var e=t.aoSearchCols;if(e)for(var i=0,n=e.length;i<n;i++)e[i]&&ah(rK.models.oSearch,e[i])}/**
 * Provide backwards compatibility for column options. Note that the new options
 * are mapped onto the old parameters, so this is an external interface change
 * only.
 *  @param {object} init Object to map
 */function af(t){au(t,"orderable","bSortable"),au(t,"orderData","aDataSort"),au(t,"orderSequence","asSorting"),au(t,"orderDataType","sortDataType");// orderData can be given as an integer
var e=t.aDataSort;"number"!=typeof e||Array.isArray(e)||(t.aDataSort=[e])}/**
 * Browser feature detection for capabilities, quirks
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function ap(t){// We don't need to do this every time DataTables is constructed, the values
// calculated are specific to the browser and OS configuration which we
// don't expect to change between initialisations
if(!rK.__browser){var e={};rK.__browser=e;// Scrolling feature / quirks detection
var i=rG("<div/>").css({position:"fixed",top:0,left:-1*rG(window).scrollLeft(),height:1,width:1,overflow:"hidden"}).append(rG("<div/>").css({position:"absolute",top:1,left:1,width:100,overflow:"scroll"}).append(rG("<div/>").css({width:"100%",height:10}))).appendTo("body"),n=i.children(),r=n.children();// Numbers below, in order, are:
...
e.bBounding=!!i[0].getBoundingClientRect().width,i.remove()}rG.extend(t.oBrowser,rK.__browser),t.oScroll.iBarWidth=rK.__browser.barWidth}/**
 * Array.prototype reduce[Right] method, used for browsers which don't support
 * JS 1.6. Done this way to reduce code size, since we iterate either way
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function ag(t,e,i,n,r,a){var o,s=n,l=!1;for(void 0!==i&&(o=i,l=!0);s!==r;)t.hasOwnProperty(s)&&(o=l?e(o,t[s],s,t):t[s],l=!0,s+=a);return o}/**
 * Add a column to the list used for the table with default values
 *  @param {object} oSettings dataTables settings object
 *  @param {node} nTh The th element for this column
 *  @memberof DataTable#oApi
 */function am(t,e){// Add column to aoColumns array
var i=rK.defaults.column,n=t.aoColumns.length,r=rG.extend({},rK.models.oColumn,i,{nTh:e||document.createElement("th"),sTitle:i.sTitle?i.sTitle:e?e.innerHTML:"",aDataSort:i.aDataSort?i.aDataSort:[n],mData:i.mData?i.mData:n,idx:n});t.aoColumns.push(r);// Add search object for column specific search. Note that the `searchCols[ iCol ]`
// passed into extend can be undefined. This allows the user to give a default
// with only some of the parameters defined, and also not give a default
var a=t.aoPreSearchCols;a[n]=rG.extend({},rK.models.oSearch,a[n]),// Use the default column options function to initialise classes etc
ab(t,n,rG(e).data())}/**
 ...
 *  @memberof DataTable#oApi
 */function ab(t,e,i){var n=t.aoColumns[e],r=t.oClasses,a=rG(n.nTh);// Try to get width information from the DOM. We can't get it from CSS
...
af(i),// Map camel case parameters to their Hungarian counterparts
ah(rK.defaults.column,i,!0),void 0===i.mDataProp||i.mData||(i.mData=i.mDataProp),i.sType&&(n._sManualType=i.sType),i.className&&!i.sClass&&(i.sClass=i.className),i.sClass&&a.addClass(i.sClass);var s=n.sClass;rG.extend(n,i),oO(n,i,"sWidth","sWidthOrig"),s!==n.sClass&&(n.sClass=s+" "+n.sClass),void 0!==i.iDataSort&&(n.aDataSort=[i.iDataSort]),oO(n,i,"aDataSort")}/* Cache the data get and set functions for speed */var l=n.mData,h=aE(l),c=n.mRender?aE(n.mRender):null,u=function(t){return"string"==typeof t&&-1!==t.indexOf("@")};n._bAttrSrc=rG.isPlainObject(l)&&(u(l.sort)||u(l.type)||u(l.filter)),n._setter=null,n.fnGetData=function(t,e,i){var n=h(t,e,void 0,i);return c&&e?c(n,e,t,i):n},n.fnSetData=function(t,e,i){return aI(l)(t,e,i)},"number"==typeof l||n._isArrayHost||(t._rowReadObject=!0),t.oFeatures.bSort||(n.bSortable=!1,a.addClass(r.sSortableNone));/* Check that the class assignment is correct for sorting */var d=-1!==rG.inArray("asc",n.asSorting),f=-1!==rG.inArray("desc",n.asSorting);n.bSortable&&(d||f)?d&&!f?(n.sSortingClass=r.sSortableAsc,n.sSortingClassJUI=r.sSortJUIAscAllowed):!d&&f?(n.sSortingClass=r.sSortableDesc,n.sSortingClassJUI=r.sSortJUIDescAllowed):(n.sSortingClass=r.sSortable,n.sSortingClassJUI=r.sSortJUI):(n.sSortingClass=r.sSortableNone,n.sSortingClassJUI="")}/**
 * Adjust the table column widths for new data. Note: you would probably want to
 * do a redraw after calling this function!
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function av(t){/* Not interested in doing column width calculation if auto-width is disabled */if(!1!==t.oFeatures.bAutoWidth){var e=t.aoColumns;om(t);for(var i=0,n=e.length;i<n;i++)e[i].nTh.style.width=e[i].sWidth}var r=t.oScroll;(""!==r.sY||""!==r.sX)&&of(t),oN(t,null,"column-sizing",[t])}/**
 ...
 *  @memberof DataTable#oApi
 */function ay(t,e){var i=aw(t,"bVisible");return"number"==typeof i[e]?i[e]:null}/**
 ...
 *  @returns {int} i the data index
 *  @memberof DataTable#oApi
 */function ax(t,e){var i=aw(t,"bVisible"),n=rG.inArray(e,i);return -1!==n?n:null}/**
 * Get the number of visible columns
 *  @param {object} oSettings dataTables settings object
 *  @returns {int} i the number of visible columns
 *  @memberof DataTable#oApi
 */function a_(t){var e=0;return(// No reduce in IE8, use a loop for now
rG.each(t.aoColumns,function(t,i){i.bVisible&&"none"!==rG(i.nTh).css("display")&&e++}),e)}/**
 ...
 *  @memberof DataTable#oApi
 */function aw(t,e){var i=[];return rG.map(t.aoColumns,function(t,n){t[e]&&i.push(n)}),i}/**
 * Calculate the 'type' of a column
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function aS(t){var e,i,n,r,a,o,s,l,h,c=t.aoColumns,u=t.aoData,d=rK.ext.type.detect;// For each column, spin over the 
for(e=0,i=c.length;e<i;e++)if(s=c[e],h=[],!s.sType&&s._sManualType)s.sType=s._sManualType;else if(!s.sType){for(n=0,r=d.length;n<r;n++){for(a=0,o=u.length;a<o&&(void 0===h[a]&&(h[a]=ak(t,a,e,"type")),((l=d[n](h[a],t))||n===d.length-1)&&("html"!==l||r3(h[a])));a++);// Type is valid for all data points in the column - use this
// type
 ...
 *  @memberof DataTable#oApi
 */function aD(t,e,i,n){var r,a,o,s,l,h,c,u=t.aoColumns;// Column definitions with aTargets
if(e)/* Loop over the definitions array - loop in reverse so first instance has priority */for(r=e.length-1;r>=0;r--){/* Each definition can target multiple columns, as it is an array */var d=void 0!==(c=e[r]).target?c.target:void 0!==c.targets?c.targets:c.aTargets;for(Array.isArray(d)||(d=[d]),o=0,s=d.length;o<s;o++)if("number"==typeof d[o]&&d[o]>=0){/* Add columns that we don't yet know about */for(;u.length<=d[o];)am(t);/* Integer, basic index */n(d[o],c)}else if("number"==typeof d[o]&&d[o]<0)/* Negative integer, right to left column counting */n(u.length+d[o],c);else if("string"==typeof d[o])/* Class name matching on TH element */for(l=0,h=u.length;l<h;l++)("_all"==d[o]||rG(u[l].nTh).hasClass(d[o]))&&n(l,c)}// Statically defined columns array
 ...
 *  @memberof DataTable#oApi
 */function aC(t,e,i,n){/* Create the object for storing information about this new row */var r=t.aoData.length,a=rG.extend(!0,{},rK.models.oRow,{src:i?"dom":"data",idx:r});a._aData=e,t.aoData.push(a);// Invalidate the column types as the new data needs to be revalidated
for(var o=t.aoColumns,s=0,l=o.length;s<l;s++)o[s].sType=null;/* Add to the display array */t.aiDisplayMaster.push(r);var h=t.rowIdFn(e);return void 0!==h&&(t.aIds[h]=a),(i||!t.oFeatures.bDeferRender)&&aH(t,r,i,n),r}/**
 ...
 *  @memberof DataTable#oApi
 */function aT(t,e){var i;return e instanceof rG||(e=rG(e)),e.map(function(e,n){return i=aN(t,n),aC(t,i.data,n,i.cells)})}/**
 ...
 *  @returns {*} Cell data
 *  @memberof DataTable#oApi
 */function ak(t,e,i,n){"search"===n?n="filter":"order"===n&&(n="sort");var r=t.iDraw,a=t.aoColumns[i],o=t.aoData[e]._aData,s=a.sDefaultContent,l=a.fnGetData(o,n,{settings:t,row:e,col:i});if(void 0===l)return t.iDrawError!=r&&null===s&&(oI(t,0,"Requested unknown parameter "+("function"==typeof a.mData?"{function}":"'"+a.mData+"'")+" for row "+e+", column "+i,4),t.iDrawError=r),s;// When the data source is null and a specific data type is requested (i.e.
...
return l.call(o);if(null===l&&"display"===n)return"";if("filter"===n){var h=rK.ext.type.search;h[a.sType]&&(l=h[a.sType](l))}return l}/**
 ...
 *  @memberof DataTable#oApi
 */function aM(t,e,i,n){var r=t.aoColumns[i],a=t.aoData[e]._aData;r.fnSetData(a,n,{settings:t,row:e,col:i})}// Private variable that is used to match action syntax in the data property object
var aA=/\[.*?\]$/,aP=/\(\)$/;/**
 * Split string on periods, taking into account escaped periods
 * @param  {string} str String to split
 * @return {array} Split string
 */function aL(t){return rG.map(t.match(/(\\.|[^\.])+/g)||[""],function(t){return t.replace(/\\\./g,".")})}/**
 * Return a function that can be used to get data from a source object, taking
 * into account the ability to use nested objects as a source
 *  @param {string|int|function} mSource The data source for the object
 *  @returns {function} Data get function
 *  @memberof DataTable#oApi
 */var aE=rK.util.get,aI=rK.util.set;/**
 * Return an array with the full table data
 *  @param {object} oSettings dataTables settings object
 *  @returns array {array} aData Master data array
 *  @memberof DataTable#oApi
 */function aO(t){return r7(t.aoData,"_aData")}/**
 * Nuke the table
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function aR(t){t.aoData.length=0,t.aiDisplayMaster.length=0,t.aiDisplay.length=0,t.aIds={}}/**
 * Take an array of integers (index array) and remove a target integer (value - not
 * the key!)
 *  @param {array} a Index array to target
 *  @param {int} iTarget value to find
 *  @memberof DataTable#oApi
 */function aF(t,e,i){for(var n=-1,r=0,a=t.length;r<a;r++)t[r]==e?n=r:t[r]>e&&t[r]--;-1!=n&&void 0===i&&t.splice(n,1)}/**
 ...
 */function aj(t,e,i,n){var r,a,o=t.aoData[e],s=function(i,n){// This is very frustrating, but in IE if you just write directly
// to innerHTML, and elements that are overwritten are GC'ed,
// even if there is a reference to them elsewhere
for(;i.childNodes.length;)i.removeChild(i.firstChild);i.innerHTML=ak(t,e,n,"display")};// Are we reading last data from DOM or the data object?
if("dom"!==i&&(i&&"auto"!==i||"dom"!==o.src)){// Reading from data object, update the DOM
var l=o.anCells;if(l){if(void 0!==n)s(l[n],n);else for(r=0,a=l.length;r<a;r++)s(l[r],r)}}else o._aData=aN(t,o,n,void 0===n?void 0:o._aData).data;// For both row and cell invalidation, the cached data for sorting and
 ...
 *   them from here).
 * @memberof DataTable#oApi
 */function aN(t,e,i,n){var r,a,o,s=[],l=e.firstChild,h=0,c=t.aoColumns,u=t._rowReadObject;// Allow the data object to be passed in, or construct
n=void 0!==n?n:u?{}:[];var d=function(t,e){if("string"==typeof t){var i=t.indexOf("@");if(-1!==i){var r=t.substring(i+1);aI(t)(n,e.getAttribute(r))}}},f=function(t){(void 0===i||i===h)&&(a=c[h],o=t.innerHTML.trim(),a&&a._bAttrSrc?(aI(a.mData._)(n,o),d(a.mData.sort,t),d(a.mData.type,t),d(a.mData.filter,t)):u?(a._setter||(a._setter=aI(a.mData)),a._setter(n,o)):n[h]=o),h++};if(l)for(;l;)("TD"==(r=l.nodeName.toUpperCase())||"TH"==r)&&(f(l),s.push(l)),l=l.nextSibling;else{// Existing row object passed in
s=e.anCells;for(var p=0,g=s.length;p<g;p++)f(s[p])}// Read the ID from the DOM if present
var m=e.firstChild?e:e.nTr;if(m){var b=m.getAttribute("id");b&&aI(t.rowId)(n,b)}return{data:n,cells:s}}/**
 ...
 *    if nTr is.
 *  @memberof DataTable#oApi
 */function aH(t,e,i,n){var r,a,o,s,l,h,c=t.aoData[e],u=c._aData,d=[];if(null===c.nTr){/* Process each column */for(r=i||document.createElement("tr"),c.nTr=r,c.anCells=d,/* Use a private property on the node to allow reserve mapping from the node
		 * to the aoData array for fast look up
		 */r._DT_RowIndex=e,/* Special parameters can be given by the data source to be used on the row */aW(t,c),s=0,l=t.aoColumns.length;s<l;s++)o=t.aoColumns[s],(a=(h=!i)?document.createElement(o.sCellType):n[s])||oI(t,0,"Incorrect column count",18),a._DT_CellIndex={row:e,column:s},d.push(a),(h||(o.mRender||o.mData!==s)&&(!rG.isPlainObject(o.mData)||o.mData._!==s+".display"))&&(a.innerHTML=ak(t,e,s,"display")),o.sClass&&(a.className+=" "+o.sClass),o.bVisible&&!i?r.appendChild(a):!o.bVisible&&i&&a.parentNode.removeChild(a),o.fnCreatedCell&&o.fnCreatedCell.call(t.oInstance,a,ak(t,e,s),u,e,s);oN(t,"aoRowCreatedCallback",null,[r,u,e,d])}}/**
 * Add attributes to a row based on the special `DT_*` parameters in a data
 * source object.
 *  @param {object} settings DataTables settings object
 *  @param {object} DataTables row object for the row to be modified
 *  @memberof DataTable#oApi
 */function aW(t,e){var i=e.nTr,n=e._aData;if(i){var r=t.rowIdFn(n);if(r&&(i.id=r),n.DT_RowClass){// Remove any classes added by DT_RowClass before
var a=n.DT_RowClass.split(" ");e.__rowc=e.__rowc?aa(e.__rowc.concat(a)):a,rG(i).removeClass(e.__rowc.join(" ")).addClass(n.DT_RowClass)}n.DT_RowAttr&&rG(i).attr(n.DT_RowAttr),n.DT_RowData&&rG(i).data(n.DT_RowData)}}/**
 * Create the HTML header for the table
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function aB(t){var e,i,n,r,a,o=t.nTHead,s=t.nTFoot,l=0===rG("th, td",o).length,h=t.oClasses,c=t.aoColumns;for(l&&(r=rG("<tr/>").appendTo(o)),e=0,i=c.length;e<i;e++)a=c[e],n=rG(a.nTh).addClass(a.sClass),l&&n.appendTo(r),t.oFeatures.bSort&&(n.addClass(a.sSortingClass),!1!==a.bSortable&&(n.attr("tabindex",t.iTabIndex).attr("aria-controls",t.sTableId),oT(t,a.nTh,e))),a.sTitle!=n[0].innerHTML&&n.html(a.sTitle),oW(t,"header")(t,n,a,h);// Cache the footer cells. Note that we only take the cells from the first
// row in the footer. If there is more than one row the user wants to
// interact with, they need to use the table().foot() method. Note also this
// allows cells to be used for multiple columns using colspan
if(l&&aU(t.aoHeader,o),/* Deal with the footer - add classes if required */rG(o).children("tr").children("th, td").addClass(h.sHeaderTH),rG(s).children("tr").children("th, td").addClass(h.sFooterTH),null!==s){var u=t.aoFooter[0];for(e=0,i=u.length;e<i;e++)(a=c[e])?(a.nTf=u[e].cell,a.sClass&&rG(a.nTf).addClass(a.sClass)):oI(t,0,"Incorrect column count",18)}}/**
 ...
 *  @memberof DataTable#oApi
 */function az(t,e,i){var n,r,a,o,s,l,h,c,u,d=[],f=[],p=t.aoColumns.length;if(e){/* Make a copy of the master layout array, but without the visible columns in it */for(void 0===i&&(i=!1),n=0,r=e.length;n<r;n++){/* Remove any columns which are currently hidden */for(d[n]=e[n].slice(),d[n].nTr=e[n].nTr,a=p-1;a>=0;a--)t.aoColumns[a].bVisible||i||d[n].splice(a,1);/* Prep the applied array - it needs an element for each row */f.push([])}for(n=0,r=d.length;n<r;n++){/* All cells are going to be replaced, so empty out the row */if(h=d[n].nTr)for(;l=h.firstChild;)h.removeChild(l);for(a=0,o=d[n].length;a<o;a++)/* Check to see if there is already a cell (row/colspan) covering our target
			 * insert point. If there is, then there is nothing to do.
			 */if(c=1,u=1,void 0===f[n][a]){/* Expand the cell to cover as many rows as needed */for(h.appendChild(d[n][a].cell),f[n][a]=1;void 0!==d[n+c]&&d[n][a].cell==d[n+c][a].cell;)f[n+c][a]=1,c++;/* Expand the cell to cover as many columns as needed */for(;void 0!==d[n][a+u]&&d[n][a].cell==d[n][a+u].cell;){/* Must update the applied array over the rows for the columns */for(s=0;s<c;s++)f[n+s][a+u]=1;u++}/* Do the actual expansion in the DOM */rG(d[n][a].cell).attr("rowspan",c).attr("colspan",u)}}}}/**
 * Insert the required TR nodes into the table for display
 *  @param {object} oSettings dataTables settings object
 *  @param ajaxComplete true after ajax call to complete rendering
 *  @memberof DataTable#oApi
 */function aV(t,e){i="ssp"==oB(t),void 0!==(n=t.iInitDisplayStart)&&-1!==n&&(t._iDisplayStart=i?n:n>=t.fnRecordsDisplay()?0:n,t.iInitDisplayStart=-1);/* Provide a pre-callback function which can be used to cancel the draw is false is returned */var i,n,r=oN(t,"aoPreDrawCallback","preDraw",[t]);if(-1!==rG.inArray(!1,r)){ou(t,!1);return}var a=[],o=0,s=t.asStripeClasses,l=s.length,h=t.oLanguage,c="ssp"==oB(t),u=t.aiDisplay,d=t._iDisplayStart,f=t.fnDisplayEnd();/* Server-side processing draw intercept */if(t.bDrawing=!0,t.bDeferLoading)t.bDeferLoading=!1,t.iDraw++,ou(t,!1);else if(c){if(!t.bDestroying&&!e){aJ(t);return}}else t.iDraw++;if(0!==u.length)for(var p=c?0:d,g=c?t.aoData.length:f,m=p;m<g;m++){var b=u[m],v=t.aoData[b];null===v.nTr&&aH(t,b);var y=v.nTr;/* Remove the old striping classes and then add the new one */if(0!==l){var x=s[o%l];v._sRowStripe!=x&&(rG(y).removeClass(v._sRowStripe).addClass(x),v._sRowStripe=x)}// Row callback functions - might want to manipulate the row
// iRowCount and j are not currently documented. Are they at all
// useful?
oN(t,"aoRowCallback",null,[y,v._aData,o,m,b]),a.push(y),o++}else{/* Table is empty - create a row with an empty message in it */var _=h.sZeroRecords;1==t.iDraw&&"ajax"==oB(t)?_=h.sLoadingRecords:h.sEmptyTable&&0===t.fnRecordsTotal()&&(_=h.sEmptyTable),a[0]=rG("<tr/>",{class:l?s[0]:""}).append(rG("<td />",{valign:"top",colSpan:a_(t),class:t.oClasses.sRowEmpty}).html(_))[0]}/* Header and footer callbacks */oN(t,"aoHeaderCallback","header",[rG(t.nTHead).children("tr")[0],aO(t),d,f,u]),oN(t,"aoFooterCallback","footer",[rG(t.nTFoot).children("tr")[0],aO(t),d,f,u]);var w=rG(t.nTBody);w.children().detach(),w.append(rG(a)),/* Call all required callback functions for the end of a draw */oN(t,"aoDrawCallback","draw",[t]),/* Draw is complete, sorting and filtering must be as well */t.bSorted=!1,t.bFiltered=!1,t.bDrawing=!1}/**
 * Redraw the table - taking account of the various features which are enabled
 *  @param {object} oSettings dataTables settings object
 *  @param {boolean} [holdPosition] Keep the current paging position. By default
 *    the paging is reset to the first page
 *  @memberof DataTable#oApi
 */function a$(t,e){var i=t.oFeatures,n=i.bSort,r=i.bFilter;n&&oS(t),r?a0(t,t.oPreviousSearch):t.aiDisplay=t.aiDisplayMaster.slice(),!0!==e&&(t._iDisplayStart=0),// Let any modules know about the draw hold position state (used by
// scrolling internally)
t._drawHold=e,aV(t),t._drawHold=!1}/**
 * Add the options to the page HTML for the table
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function aq(t){var e,i,n,r,a,o,s=t.oClasses,l=rG(t.nTable),h=rG("<div/>").insertBefore(l),c=t.oFeatures,u=rG("<div/>",{id:t.sTableId+"_wrapper",class:s.sWrapper+(t.nTFoot?"":" "+s.sNoFooter)});t.nHolding=h[0],t.nTableWrapper=u[0],t.nTableReinsertBefore=t.nTable.nextSibling;for(var d=t.sDom.split(""),f=0;f<d.length;f++){if(e=null,"<"==(i=d[f])){if(/* New container div */n=rG("<div/>")[0],"'"==/* Check to see if we should append an id and/or a class name to the container */(r=d[f+1])||'"'==r){for(a="",o=2;d[f+o]!=r;)a+=d[f+o],o++;/* The attribute can be in the format of "#id.class", "#id" or "class" This logic
				 * breaks the string into parts and applies them as needed
				 */if("H"==a?a=s.sJUIHeader:"F"==a&&(a=s.sJUIFooter),-1!=a.indexOf(".")){var p=a.split(".");n.id=p[0].substr(1,p[0].length-1),n.className=p[1]}else"#"==a.charAt(0)?n.id=a.substr(1,a.length-1):n.className=a;f+=o}u.append(n),u=rG(n)}else if(">"==i)/* End container div */u=u.parent();else if("l"==i&&c.bPaginate&&c.bLengthChange)/* Length */e=os(t);else if("f"==i&&c.bFilter)/* Filter */e=aQ(t);else if("r"==i&&c.bProcessing)/* pRocessing */e=oc(t);else if("t"==i)/* Table */e=od(t);else if("i"==i&&c.bInfo)/* Info */e=oe(t);else if("p"==i&&c.bPaginate)/* Pagination */e=ol(t);else if(0!==rK.ext.feature.length){for(var g=rK.ext.feature,m=0,b=g.length;m<b;m++)if(i==g[m].cFeature){e=g[m].fnInit(t);break}}/* Add to the 2D features array */if(e){var v=t.aanFeatures;v[i]||(v[i]=[]),v[i].push(e),u.append(e)}}/* Built our DOM structure - replace the holding div with what we want */h.replaceWith(u),t.nHolding=null}/**
 ...
 *  @memberof DataTable#oApi
 */function aX(t,e,i){var n=[];!i&&(i=t.aoHeader,e&&aU(i=[],e));for(var r=0,a=i.length;r<a;r++)for(var o=0,s=i[r].length;o<s;o++)!i[r][o].unique||n[o]&&t.bSortCellsTop||(n[o]=i[r][o].cell);return n}/**
 ...
 */function aY(t,e,i){// Convert to object based for 1.10+ if using the old array scheme which can
// come from server-side processing or serverParams
if(// Compatibility with 1.9-, allow fnServerData and event to manipulate
oN(t,"aoServerParams","serverParams",[e]),e&&Array.isArray(e)){var n,r={},a=/(.*?)\[\]$/;rG.each(e,function(t,e){var i=e.name.match(a);if(i){// Support for arrays
var n=i[0];r[n]||(r[n]=[]),r[n].push(e.value)}else r[e.name]=e.value}),e=r}var o=t.ajax,s=t.oInstance,l=function(e){var n=t.jqXHR?t.jqXHR.status:null;(null===e||"number"==typeof n&&204==n)&&aZ(t,e={},[]);var r=e.error||e.sError;r&&oI(t,0,r),t.json=e,oN(t,null,"xhr",[t,e,t.jqXHR]),i(e)};if(rG.isPlainObject(o)&&o.data){var h="function"==typeof(n=o.data)?n(e,t):n;// an object object or array to merge
// If the function returned something, use that alone
e="function"==typeof n&&h?h:rG.extend(!0,e,h),// Remove the data property as we've resolved it already and don't want
// jQuery to do it again (it is restored at the end of the function)
delete o.data}var c={data:e,success:l,dataType:"json",cache:!1,type:t.sServerMethod,error:function(e,i,n){var r=oN(t,null,"xhr",[t,null,t.jqXHR]);-1===rG.inArray(!0,r)&&("parsererror"==i?oI(t,0,"Invalid JSON response",1):4===e.readyState&&oI(t,0,"Ajax error",7)),ou(t,!1)}};// Store the data submitted for the API
t.oAjaxData=e,// Allow plug-ins and external processes to modify the data
oN(t,null,"preXhr",[t,e]),t.fnServerData?t.fnServerData.call(s,t.sAjaxSource,rG.map(e,function(t,e){return{name:e,value:t}}),l,t):t.sAjaxSource||"string"==typeof o?t.jqXHR=rG.ajax(rG.extend(c,{url:o||t.sAjaxSource})):"function"==typeof o?t.jqXHR=o.call(s,e,l,t):(// Object to extend the base settings
t.jqXHR=rG.ajax(rG.extend(c,o)),// Restore for next time around
o.data=n)}/**
 * Update the table using an Ajax call
 *  @param {object} settings dataTables settings object
 *  @returns {boolean} Block the table drawing or not
 *  @memberof DataTable#oApi
 */function aJ(t){t.iDraw++,ou(t,!0);// Keep track of drawHold state to handle scrolling after the Ajax call
var e=t._drawHold;aY(t,aG(t),function(i){t._drawHold=e,aK(t,i),t._drawHold=!1})}/**
 ...
 *  @memberof DataTable#oApi
 */function aK(t,e){// v1.10 uses camelCase variables, while 1.9 uses Hungarian notation.
// Support both
var i=function(t,i){return void 0!==e[t]?e[t]:e[i]},n=aZ(t,e),r=i("sEcho","draw"),a=i("iTotalRecords","recordsTotal"),o=i("iTotalDisplayRecords","recordsFiltered");if(void 0!==r){// Protect against out of sequence returns
if(1*r<t.iDraw)return;t.iDraw=1*r}n||(n=[]),aR(t),t._iRecordsTotal=parseInt(a,10),t._iRecordsDisplay=parseInt(o,10);for(var s=0,l=n.length;s<l;s++)aC(t,n[s]);t.aiDisplay=t.aiDisplayMaster.slice(),aV(t,!0),t._bInitComplete||oa(t,e),ou(t,!1)}/**
 ...
 */function aZ(t,e,i){var n=rG.isPlainObject(t.ajax)&&void 0!==t.ajax.dataSrc?t.ajax.dataSrc:t.sAjaxDataProp;// Compatibility with 1.9-.
if(!i)return"data"===n?e.aaData||e[n]:""!==n?aE(n)(e):e;// set
aI(n)(e,i)}/**
 * Generate the node required for filtering text
 *  @returns {node} Filter control element
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function aQ(t){var e=t.oClasses,i=t.sTableId,n=t.oLanguage,r=t.oPreviousSearch,a=t.aanFeatures,o='<input type="search" class="'+e.sFilterInput+'"/>',s=n.sSearch;s=s.match(/_INPUT_/)?s.replace("_INPUT_",o):s+o;var l=rG("<div/>",{id:a.f?null:i+"_filter",class:e.sFilter}).append(rG("<label/>").append(s)),h=function(e){/* Update all other filter input elements for the new display */a.f;var i=this.value?this.value:"";// mental IE8 fix :-(
r.return&&"Enter"!==e.key||i==r.sSearch||(a0(t,{sSearch:i,bRegex:r.bRegex,bSmart:r.bSmart,bCaseInsensitive:r.bCaseInsensitive,return:r.return}),// Need to redraw, without resorting
t._iDisplayStart=0,aV(t))},c=null!==t.searchDelay?t.searchDelay:"ssp"===oB(t)?400:0,u=rG("input",l).val(r.sSearch).attr("placeholder",n.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT",c?ob(h,c):h).on("mouseup.DT",function(t){// Edge fix! Edge 17 does not trigger anything other than mouse events when clicking
...
rG(t.nTable).on("search.dt.DT",function(e,i){if(t===i)// inside an iframe or frame...
 ...
 *  @memberof DataTable#oApi
 */function a0(t,e,i){var n=t.oPreviousSearch,r=t.aoPreSearchCols,a=function(t){/* Save the filtering values */n.sSearch=t.sSearch,n.bRegex=t.bRegex,n.bSmart=t.bSmart,n.bCaseInsensitive=t.bCaseInsensitive,n.return=t.return},o=function(t){// Backwards compatibility with the bEscapeRegex option
...
aS(t),"ssp"!=oB(t)){/* Global filter */a5(t,e.sSearch,i,o(e),e.bSmart,e.bCaseInsensitive),a(e);/* Now do the individual column filter */for(var s=0;s<r.length;s++)a2(t,r[s].sSearch,s,o(r[s]),r[s].bSmart,r[s].bCaseInsensitive);/* Custom filtering */a1(t)}else a(e);/* Tell the draw function we have been filtering */t.bFiltered=!0,oN(t,null,"search",[t])}/**
 * Apply custom filtering functions
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function a1(t){for(var e,i,n=rK.ext.search,r=t.aiDisplay,a=0,o=n.length;a<o;a++){// Loop over each row and see if it should be included
 ...
 *  @memberof DataTable#oApi
 */function a2(t,e,i,n,r,a){if(""!==e){for(var o,s=[],l=t.aiDisplay,h=a3(e,n,r,a),c=0;c<l.length;c++)o=t.aoData[l[c]]._aFilterData[i],h.test(o)&&s.push(l[c]);t.aiDisplay=s}}/**
 ...
 *  @memberof DataTable#oApi
 */function a5(t,e,i,n,r,a){var o,s,l,h=a3(e,n,r,a),c=t.oPreviousSearch.sSearch,u=t.aiDisplayMaster,d=[];// If the input is blank - we just want the full data set
if(0!==rK.ext.search.length&&(i=!0),// Check if any of the rows were invalidated
s=a9(t),e.length<=0)t.aiDisplay=u.slice();else{for((s||i||n||c.length>e.length||0!==e.indexOf(c)||t.bSorted// On resort, the display master needs to be
 ...
 *  @memberof DataTable#oApi
 */function a3(t,e,i,n){return t=e?t:a4(t),i&&(t="^(?=.*?"+rG.map(t.match(/["\u201C][^"\u201D]+["\u201D]|[^ ]+/g)||[""],function(t){if('"'===t.charAt(0)){var e=t.match(/^"(.*)"$/);t=e?e[1]:t}else if("“"===t.charAt(0)){var e=t.match(/^\u201C(.*)\u201D$/);t=e?e[1]:t}return t.replace('"',"")}).join(")(?=.*?")+").*$"),new RegExp(t,n?"i":"")}/**
 * Escape a string such that it can be used in a regular expression
 *  @param {string} sVal string to escape
 *  @returns {string} escaped string
 *  @memberof DataTable#oApi
 */var a4=rK.util.escapeRegex,a8=rG("<div>")[0],a6=void 0!==a8.textContent;// Update the filtering data for each row if needed (by invalidation or first run)
function a9(t){var e,i,n,r,a,o,s,l=t.aoColumns,h=!1;for(e=0,n=t.aoData.length;e<n;e++)if(!(s=t.aoData[e])._aFilterData){for(i=0,a=[],r=l.length;i<r;i++)l[i].bSearchable?(null===(o=ak(t,e,i,"filter"))&&(o=""),"string"!=typeof o&&o.toString&&(o=o.toString())):o="",o.indexOf&&-1!==o.indexOf("&")&&(a8.innerHTML=o,o=a6?a8.textContent:a8.innerText),o.replace&&(o=o.replace(/[\r\n\u2028]/g,"")),a.push(o);s._aFilterData=a,s._sFilterRow=a.join("  "),h=!0}return h}/**
 * Convert from the internal Hungarian notation to camelCase for external
 * interaction
 *  @param {object} obj Object to convert
 *  @returns {object} Inverted object
 *  @memberof DataTable#oApi
 */function a7(t){return{search:t.sSearch,smart:t.bSmart,regex:t.bRegex,caseInsensitive:t.bCaseInsensitive}}/**
 * Convert from camelCase notation to the internal Hungarian. We could use the
 * Hungarian convert function here, but this is cleaner
 *  @param {object} obj Object to convert
 *  @returns {object} Inverted object
 *  @memberof DataTable#oApi
 */function ot(t){return{sSearch:t.search,bSmart:t.smart,bRegex:t.regex,bCaseInsensitive:t.caseInsensitive}}/**
 * Generate the node required for the info display
 *  @param {object} oSettings dataTables settings object
 *  @returns {node} Information element
 *  @memberof DataTable#oApi
 */function oe(t){var e=t.sTableId,i=t.aanFeatures.i,n=rG("<div/>",{class:t.oClasses.sInfo,id:i?null:e+"_info"});return i||(// Update display on each draw
t.aoDrawCallback.push({fn:oi,sName:"information"}),n.attr("role","status").attr("aria-live","polite"),// Table is described by our info div
rG(t.nTable).attr("aria-describedby",e+"_info")),n[0]}/**
 * Update the information elements in the display
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function oi(t){/* Show information about the table */var e=t.aanFeatures.i;if(0!==e.length){var i=t.oLanguage,n=t._iDisplayStart+1,r=t.fnDisplayEnd(),a=t.fnRecordsTotal(),o=t.fnRecordsDisplay(),s=o?i.sInfo:i.sInfoEmpty;o!==a&&/* Record set after filtering */(s+=" "+i.sInfoFiltered),// Convert the macros
s+=i.sInfoPostFix,s=on(t,s);var l=i.fnInfoCallback;null!==l&&(s=l.call(t.oInstance,t,n,r,a,o,s)),rG(e).html(s)}}function on(t,e){// When infinite scrolling, we are always starting at 1. _iDisplayStart is used only
// internally
 ...
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function or(t){var e,i,n,r=t.iInitDisplayStart,a=t.aoColumns,o=t.oFeatures,s=t.bDeferLoading;/* Ensure that the table data is fully initialised */if(!t.bInitialised){setTimeout(function(){or(t)},200);return}for(/* Show the display HTML options */aq(t),/* Build and draw the header / footer for the table */aB(t),az(t,t.aoHeader),az(t,t.aoFooter),/* Okay to show that something is going on now */ou(t,!0),o.bAutoWidth&&om(t),e=0,i=a.length;e<i;e++)(n=a[e]).sWidth&&(n.nTh.style.width=o_(n.sWidth));oN(t,null,"preInit",[t]),// If there is default sorting required - let's do it. The sort function
// will do the drawing for us. Otherwise we draw the table regardless of the
// Ajax source - this allows the table to look initialised for Ajax sourcing
// data (show 'loading' message possibly)
a$(t);// Server-side processing init complete is done by _fnAjaxUpdateDraw
var l=oB(t);("ssp"!=l||s)&&("ajax"==l?aY(t,[],function(i){var n=aZ(t,i);// Got the data - add it to the table
for(e=0;e<n.length;e++)aC(t,n[e]);// Reset the init display for cookie saving. We've already done
// a filter, and therefore cleared it before. So we need to make
// it appear 'fresh'
t.iInitDisplayStart=r,a$(t),ou(t,!1),oa(t,i)},t):(ou(t,!1),oa(t)))}/**
 * Draw the table for the first time, adding all required features
 *  @param {object} oSettings dataTables settings object
 *  @param {object} [json] JSON from the server that completed the table, if using Ajax source
 *    with client-side processing (optional)
 *  @memberof DataTable#oApi
 */function oa(t,e){t._bInitComplete=!0,(e||t.oInit.aaData)&&av(t),oN(t,null,"plugin-init",[t,e]),oN(t,"aoInitComplete","init",[t,e])}function oo(t,e){var i=parseInt(e,10);t._iDisplayLength=i,oH(t),// Fire length change event
oN(t,null,"length",[t,i])}/**
 * Generate the node required for user display length changing
 *  @param {object} settings dataTables settings object
 *  @returns {node} Display length feature node
 *  @memberof DataTable#oApi
 */function os(t){for(var e=t.oClasses,i=t.sTableId,n=t.aLengthMenu,r=Array.isArray(n[0]),a=r?n[0]:n,o=r?n[1]:n,s=rG("<select/>",{name:i+"_length","aria-controls":i,class:e.sLengthSelect}),l=0,h=a.length;l<h;l++)s[0][l]=new Option("number"==typeof o[l]?t.fnFormatNumber(o[l]):o[l],a[l]);var c=rG("<div><label/></div>").addClass(e.sLength);return t.aanFeatures.l||(c[0].id=i+"_length"),c.children().append(t.oLanguage.sLengthMenu.replace("_MENU_",s[0].outerHTML)),// Can't use `select` variable as user might provide their own and the
// reference is broken by the use of outerHTML
rG("select",c).val(t._iDisplayLength).on("change.DT",function(e){oo(t,rG(this).val()),aV(t)}),// Update node value whenever anything changes the table's length
rG(t.nTable).on("length.dt.DT",function(e,i,n){t===i&&rG("select",c).val(n)}),c[0]}/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 *  @memberof DataTable#oApi
 */function ol(t){var e=t.sPaginationType,i=rK.ext.pager[e],n="function"==typeof i,r=function(t){aV(t)},a=rG("<div/>").addClass(t.oClasses.sPaging+e)[0],o=t.aanFeatures;return n||i.fnInit(t,a,r),o.p||(a.id=t.sTableId+"_paginate",t.aoDrawCallback.push({fn:function(t){if(n){var e,a,s=t._iDisplayStart,l=t._iDisplayLength,h=t.fnRecordsDisplay(),c=-1===l,u=c?0:Math.ceil(s/l),d=c?1:Math.ceil(h/l),f=i(u,d);for(e=0,a=o.p.length;e<a;e++)oW(t,"pageButton")(t,o.p[e],e,f,u,d)}else i.fnUpdate(t,r)},sName:"pagination"})),a}/**
 ...
 *  @memberof DataTable#oApi
 */function oh(t,e,i){var n=t._iDisplayStart,r=t._iDisplayLength,a=t.fnRecordsDisplay();0===a||-1===r?n=0:"number"==typeof e?(n=e*r)>a&&(n=0):"first"==e?n=0:"previous"==e?(n=r>=0?n-r:0)<0&&(n=0):"next"==e?n+r<a&&(n+=r):"last"==e?n=Math.floor((a-1)/r)*r:oI(t,0,"Unknown paging action: "+e,5);var o=t._iDisplayStart!==n;return t._iDisplayStart=n,o?(oN(t,null,"page",[t]),i&&aV(t)):oN(t,null,"page-nc",[t]),o}/**
 * Generate the node required for the processing node
 *  @param {object} settings dataTables settings object
 *  @returns {node} Processing element
 *  @memberof DataTable#oApi
 */function oc(t){return rG("<div/>",{id:t.aanFeatures.r?null:t.sTableId+"_processing",class:t.oClasses.sProcessing,role:"status"}).html(t.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>").insertBefore(t.nTable)[0]}/**
 * Display or hide the processing indicator
 *  @param {object} settings dataTables settings object
 *  @param {bool} show Show the processing indicator (true) or not (false)
 *  @memberof DataTable#oApi
 */function ou(t,e){t.oFeatures.bProcessing&&rG(t.aanFeatures.r).css("display",e?"block":"none"),oN(t,null,"processing",[t,e])}/**
 * Add any control elements for the table - specifically scrolling
 *  @param {object} settings dataTables settings object
 *  @returns {node} Node to add to the DOM
 *  @memberof DataTable#oApi
 */function od(t){var e=rG(t.nTable),i=t.oScroll;if(""===i.sX&&""===i.sY)return t.nTable;var n=i.sX,r=i.sY,a=t.oClasses,o=e.children("caption"),s=o.length?o[0]._captionSide:null,l=rG(e[0].cloneNode(!1)),h=rG(e[0].cloneNode(!1)),c=e.children("tfoot"),u="<div/>",d=function(t){return t?o_(t):null};c.length||(c=null);/*
	 ...
	 *          tfoot - tfoot
	 */var f=rG(u,{class:a.sScrollWrapper}).append(rG(u,{class:a.sScrollHead}).css({overflow:"hidden",position:"relative",border:0,width:n?d(n):"100%"}).append(rG(u,{class:a.sScrollHeadInner}).css({"box-sizing":"content-box",width:i.sXInner||"100%"}).append(l.removeAttr("id").css("margin-left",0).append("top"===s?o:null).append(e.children("thead"))))).append(rG(u,{class:a.sScrollBody}).css({position:"relative",overflow:"auto",width:d(n)}).append(e));c&&f.append(rG(u,{class:a.sScrollFoot}).css({overflow:"hidden",border:0,width:n?d(n):"100%"}).append(rG(u,{class:a.sScrollFootInner}).append(h.removeAttr("id").css("margin-left",0).append("bottom"===s?o:null).append(e.children("tfoot")))));var p=f.children(),g=p[0],m=p[1],b=c?p[2]:null;return n&&rG(m).on("scroll.DT",function(t){var e=this.scrollLeft;g.scrollLeft=e,c&&(b.scrollLeft=e)}),rG(m).css("max-height",r),i.bCollapse||rG(m).css("height",r),t.nScrollHead=g,t.nScrollBody=m,t.nScrollFoot=b,// On redraw - align columns
t.aoDrawCallback.push({fn:of,sName:"scrolling"}),f[0]}/**
 ...
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function of(t){// Given that this is such a monster function, a lot of variables are use
// to try and keep the minimised size as small as possible
var e,i,n,r,a,o,s,l,h,c=t.oScroll,u=c.sX,d=c.sXInner,f=c.sY,p=c.iBarWidth,g=rG(t.nScrollHead),m=g[0].style,b=g.children("div"),v=b[0].style,y=b.children("table"),x=t.nScrollBody,_=rG(x),w=x.style,S=rG(t.nScrollFoot).children("div"),D=S.children("table"),C=rG(t.nTHead),T=rG(t.nTable),k=T[0],M=k.style,A=t.nTFoot?rG(t.nTFoot):null,P=t.oBrowser,L=P.bScrollOversize,E=(r7(t.aoColumns,"nTh"),[]),I=[],O=[],R=[],F=function(t){var e=t.style;e.paddingTop="0",e.paddingBottom="0",e.borderTopWidth="0",e.borderBottomWidth="0",e.height=0},j=x.scrollHeight>x.clientHeight;if(t.scrollBarVis!==j&&void 0!==t.scrollBarVis){t.scrollBarVis=j,av(t);return;// adjust column sizing will call this function again
}t.scrollBarVis=j,/*
	 * 1. Re-create the table inside the scrolling div
...
a=C.clone().prependTo(T),e=C.find("tr"),n=a.find("tr"),a.find("th, td").removeAttr("tabindex"),a.find("[id]").removeAttr("id"),u||(w.width="100%",g[0].style.width="100%"),rG.each(aX(t,a),function(e,i){s=ay(t,e),i.style.width=t.aoColumns[s].sWidth}),A&&op(function(t){t.style.width=""},r),// Size the table as a whole
h=T.outerWidth(),""===u?(// No x scrolling
M.width="100%",L&&(T.find("tbody").height()>x.offsetHeight||"scroll"==_.css("overflow-y"))&&(M.width=o_(T.outerWidth()-p)),// Recalculate the sanity width
h=T.outerWidth()):""!==d&&(// legacy x scroll inner has been given - use it
M.width=o_(d),// Recalculate the sanity width
h=T.outerWidth()),// Hidden header should have zero height, so remove padding and borders. Then
// set the width based on the real headers
// Apply all styles in one pass
op(F,n),// Read all widths in next pass
op(function(t){var e=window.getComputedStyle?window.getComputedStyle(t).width:o_(rG(t).width());O.push(t.innerHTML),E.push(e)},n),// Apply all widths in final pass
op(function(t,e){t.style.width=E[e]},e),rG(n).css("height",0),A&&(op(F,r),op(function(t){R.push(t.innerHTML),I.push(o_(rG(t).css("width")))},r),op(function(t,e){t.style.width=I[e]},i),rG(r).height(0)),/*
	 * 3. Apply the measurements
	 */// "Hide" the header and footer that we used for the sizing. We need to keep
// the content of the cell so that the width applied to the header and body
// both match, but we want to hide it completely. We want to also fix their
// width to what they currently are
op(function(t,e){t.innerHTML='<div class="dataTables_sizing">'+O[e]+"</div>",t.childNodes[0].style.height="0",t.childNodes[0].style.overflow="hidden",t.style.width=E[e]},n),A&&op(function(t,e){t.innerHTML='<div class="dataTables_sizing">'+R[e]+"</div>",t.childNodes[0].style.height="0",t.childNodes[0].style.overflow="hidden",t.style.width=I[e]},r),Math.round(T.outerWidth())<Math.round(h)?(// The min width depends upon if we have a vertical scrollbar visible or not */
l=x.scrollHeight>x.offsetHeight||"scroll"==_.css("overflow-y")?h+p:h,L&&(x.scrollHeight>x.offsetHeight||"scroll"==_.css("overflow-y"))&&(M.width=o_(l-p)),(""===u||""!==d)&&oI(t,1,"Possible column misalignment",6)):l="100%",// Apply to the container elements
w.width=o_(l),m.width=o_(l),A&&(t.nScrollFoot.style.width=o_(l)),!f&&L&&(w.height=o_(k.offsetHeight+p));/* Finally set the width's of the header and footer tables */var N=T.outerWidth();y[0].style.width=o_(N),v.width=o_(N);// Figure out if there are scrollbar present - if so then we need a the header and footer to
// provide a bit more space to allow "overflow" scrolling (i.e. past the scrollbar)
var H=T.height()>x.clientHeight||"scroll"==_.css("overflow-y"),W="padding"+(P.bScrollbarLeft?"Left":"Right");v[W]=H?p+"px":"0px",A&&(D[0].style.width=o_(N),S[0].style.width=o_(N),S[0].style[W]=H?p+"px":"0px"),// Correct DOM ordering for colgroup - comes before the thead
 ...
 *  @memberof DataTable#oApi
 */function op(t,e,i){for(var n,r,a=0,o=0,s=e.length;o<s;){for(n=e[o].firstChild,r=i?i[o].firstChild:null;n;)1===n.nodeType&&(i?t(n,r,a):t(n,a),a++),n=n.nextSibling,r=i?r.nextSibling:null;o++}}var og=/<.*?>/g;/**
 * Calculate the width of columns for the table
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function om(t){var e,i,n,r=t.nTable,a=t.aoColumns,o=t.oScroll,s=o.sY,l=o.sX,h=o.sXInner,c=a.length,u=aw(t,"bVisible"),d=rG("th",t.nTHead),f=r.getAttribute("width"),p=r.parentNode,g=!1,m=t.oBrowser,b=m.bScrollOversize,v=r.style.width;/* Convert any user input sizes into pixel sizes */for(v&&-1!==v.indexOf("%")&&(f=v),e=0;e<u.length;e++)null!==(i=a[u[e]]).sWidth&&(i.sWidth=ov(i.sWidthOrig,p),g=!0);/* If the number of columns in the DOM equals the number that we have to
	 * process in DataTables, then we can use the offsets that are created by
	 * the web- browser. No custom sizes can be set in order for this to happen,
	 * nor scrolling used
	 */if(!b&&(g||l||s||c!=a_(t)||c!=d.length)){// Otherwise construct a single row, worst case, table with the widest
// node in the data, assign any user defined widths, then insert it into
// the DOM and allow the browser to do all the hard work of calculating
// table widths
var y=rG(r).clone()// don't use cloneNode - IE8 will remove events on the main table
.css("visibility","hidden").removeAttr("id");// Clean up the table body
y.find("tbody tr").remove();var x=rG("<tr/>").appendTo(y.find("tbody"));for(// Clone the table header and footer - we can't use the header / footer
// from the cloned table, since if scrolling is active, the table's
// real header and footer are contained in different table tags
y.find("thead, tfoot").remove(),y.append(rG(t.nTHead).clone()).append(rG(t.nTFoot).clone()),// Remove any assigned widths from the footer (from scrolling)
y.find("tfoot th, tfoot td").css("width",""),// Apply custom sizing to the cloned header
d=aX(t,y.find("thead")[0]),e=0;e<u.length;e++)i=a[u[e]],d[e].style.width=null!==i.sWidthOrig&&""!==i.sWidthOrig?o_(i.sWidthOrig):"",i.sWidthOrig&&l&&rG(d[e]).append(rG("<div/>").css({width:i.sWidthOrig,margin:0,padding:0,border:0,height:1}));// Find the widest cell for each column and put it into the table
if(t.aoData.length)for(e=0;e<u.length;e++)i=a[n=u[e]],rG(oy(t,n)).clone(!1).append(i.sContentPadding).appendTo(x);// Tidy the temporary table - remove name attributes so there aren't
// duplicated in the dom (radio elements for example)
rG("[name]",y).removeAttr("name");// Table has been built, attach to the document so we can work with it.
// A holding element is used, positioned at the top of the container
// with minimal height, so it has no effect on if the container scrolls
// or not. Otherwise it might trigger scrolling when it actually isn't
// needed
var _=rG("<div/>").css(l||s?{position:"absolute",top:0,left:0,height:1,right:0,overflow:"hidden"}:{}).append(y).appendTo(p);l&&h?y.width(h):l?(y.css("width","auto"),y.removeAttr("width"),y.width()<p.clientWidth&&f&&y.width(p.clientWidth)):s?y.width(p.clientWidth):f&&y.width(f);// Get the width of each column in the constructed table - we need to
// know the inner width (so it can be assigned to the other table's
// cells) and the outer width so we can calculate the full width of the
// table. This is safe since DataTables requires a unique cell for each
// column, but if ever a header can span multiple columns, this will
// need to be modified.
var w=0;for(e=0;e<u.length;e++){var S=rG(d[e]),D=S.outerWidth()-S.width(),C=m.bBounding?Math.ceil(d[e].getBoundingClientRect().width):S.outerWidth();// Total is tracked to remove any sub-pixel errors as the outerWidth
// of the table might not equal the total given here (IE!).
w+=C,// Width for each column to use
a[u[e]].sWidth=o_(C-D)}r.style.width=o_(w),// Finished with the table - ditch it
_.remove()}else for(e=0;e<c;e++){var T=ay(t,e);null!==T&&(a[T].sWidth=o_(d.eq(e).width()))}if(f&&(r.style.width=o_(f)),(f||l)&&!t._reszEvt){var k=function(){rG(window).on("resize.DT-"+t.sInstance,ob(function(){av(t)}))};b?setTimeout(k,1e3):k(),t._reszEvt=!0}}/**
 ...
 *  @memberof DataTable#oApi
 */var ob=rK.util.throttle;/**
 * Convert a CSS unit width to pixels (e.g. 2em)
 *  @param {string} width width to be converted
 *  @param {node} parent parent to get the with for (required for relative widths) - optional
 *  @returns {int} width in pixels
 *  @memberof DataTable#oApi
 */function ov(t,e){if(!t)return 0;var i=rG("<div/>").css("width",o_(t)).appendTo(e||document.body),n=i[0].offsetWidth;return i.remove(),n}/**
 * Get the widest node
 *  @param {object} settings dataTables settings object
 *  @param {int} colIdx column of interest
 *  @returns {node} widest table node
 *  @memberof DataTable#oApi
 */function oy(t,e){var i=ox(t,e);if(i<0)return null;var n=t.aoData[i];return n.nTr?n.anCells[e]:rG("<td/>").html(ak(t,i,e,"display"))[0]}/**
 * Get the maximum strlen for each data column
 *  @param {object} settings dataTables settings object
 *  @param {int} colIdx column of interest
 *  @returns {string} max string length for each column
 *  @memberof DataTable#oApi
 */function ox(t,e){for(var i,n=-1,r=-1,a=0,o=t.aoData.length;a<o;a++)(i=(i=(i=ak(t,a,e,"display")+"").replace(og,"")).replace(/&nbsp;/g," ")).length>n&&(n=i.length,r=a);return r}/**
 * Append a CSS unit (only if required) to a string
 *  @param {string} value to css-ify
 *  @returns {string} value with css unit
 *  @memberof DataTable#oApi
 */function o_(t){return null===t?"0px":"number"==typeof t?t<0?"0px":t+"px":t.match(/\d$/)?t+"px":t}function ow(t){var e,i,n,r,a,o,s,l=[],h=t.aoColumns,c=t.aaSortingFixed,u=rG.isPlainObject(c),d=[],f=function(t){t.length&&!Array.isArray(t[0])?d.push(t):rG.merge(d,t)};for(Array.isArray(c)&&f(c),u&&c.pre&&f(c.pre),f(t.aaSorting),u&&c.post&&f(c.post),e=0;e<d.length;e++)for(i=0,n=(r=h[s=d[e][0]].aDataSort).length;i<n;i++)o=h[a=r[i]].sType||"string",void 0===d[e]._idx&&(d[e]._idx=rG.inArray(d[e][1],h[a].asSorting)),l.push({src:s,col:a,dir:d[e][1],index:d[e]._idx,type:o,formatter:rK.ext.type.order[o+"-pre"]});return l}/**
 * Change the order of the table
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 *  @todo This really needs split up!
 */function oS(t){var e,i,n,r,a,o=[],s=rK.ext.type.order,l=t.aoData,h=(t.aoColumns,0),c=t.aiDisplayMaster;for(// Resolve any column types that are unknown due to addition or invalidation
// @todo Can this be moved into a 'data-ready' handler which is called when
//   data is going to be used in the table?
aS(t),e=0,i=(a=ow(t)).length;e<i;e++)(r=a[e]).formatter&&h++,// Load the data needed for the sort, for each cell
oM(t,r.col);/* No sorting required if server-side or no sorting array */if("ssp"!=oB(t)&&0!==a.length){// Create a value - key array of the current row positions such that we can use their
...
// methods.
c.sort(function(t,e){var i,n,r,h,c,u=a.length,d=l[t]._aSortData,f=l[e]._aSortData;for(r=0;r<u;r++)if(i=d[(c=a[r]).col],n=f[c.col],0!==(h=(s[c.type+"-"+c.dir]||s["string-"+c.dir])(i,n)))return h;return(i=o[t])<(n=o[e])?-1:i>n?1:0})}/* Tell the draw function that we have sorted the data */t.bSorted=!0}function oD(t){// ARIA attributes - need to loop all columns, to update all (removing old
// attributes as needed)
for(var e,i,n=t.aoColumns,r=ow(t),a=t.oLanguage.oAria,o=0,s=n.length;o<s;o++){var l=n[o],h=l.asSorting,c=l.ariaTitle||l.sTitle.replace(/<.*?>/g,""),u=l.nTh;// IE7 is throwing an error when setting these properties with jQuery's
 ...
 *  @memberof DataTable#oApi
 */function oC(t,e,i,n){var r,a=t.aoColumns[e],o=t.aaSorting,s=a.asSorting,l=function(t,e){var i=t._idx;return void 0===i&&(i=rG.inArray(t[1],s)),i+1<s.length?i+1:e?null:0};// If appending the sort then we are multi-column sorting
if("number"==typeof o[0]&&(o=t.aaSorting=[o]),i&&t.oFeatures.bSortMulti){// Are we already doing some kind of sort on this column?
var h=rG.inArray(e,r7(o,"0"));-1!==h?(null===// Yes, modify the sort
 ...
 *  @param {function} [callback] callback function
 *  @memberof DataTable#oApi
 */function oT(t,e,i,n){var r=t.aoColumns[i];oF(e,{},function(e){/* If the column is not sortable - don't to anything */!1!==r.bSortable&&(t.oFeatures.bProcessing?(ou(t,!0),setTimeout(function(){oC(t,i,e.shiftKey,n),"ssp"!==oB(t)&&ou(t,!1)},0)):oC(t,i,e.shiftKey,n))})}/**
 * Set the sorting classes on table's body, Note: it is safe to call this function
 * when bSort and bSortClasses are false
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function ok(t){var e,i,n,r=t.aLastSort,a=t.oClasses.sSortColumn,o=ow(t),s=t.oFeatures;if(s.bSort&&s.bSortClasses){// Remove old sorting classes
for(e=0,i=r.length;e<i;e++)n=r[e].src,// Remove column sorting
rG(r7(t.aoData,"anCells",n)).removeClass(a+(e<2?e+1:3));// Add new column sorting
for(e=0,i=o.length;e<i;e++)n=o[e].src,rG(r7(t.aoData,"anCells",n)).addClass(a+(e<2?e+1:3))}t.aLastSort=o}// Get the data to sort a column, be it from cache, fresh (populating the
// cache), or from a sort formatter
function oM(t,e){// Custom sorting function - provided by the sort data type
var i,n,r,a=t.aoColumns[e],o=rK.ext.order[a.sSortDataType];o&&(i=o.call(t.oInstance,t,e,ax(t,e)));for(var s=rK.ext.type.order[a.sType+"-pre"],l=0,h=t.aoData.length;l<h;l++)(n=t.aoData[l])._aSortData||(n._aSortData=[]),(!n._aSortData[e]||o)&&(r=o?i[l]:ak(t,l,e,"sort"),n._aSortData[e]=s?s(r):r)}/**
 * Save the state of a table
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function oA(t){if(!t._bLoadingState){/* Store the interesting variables */var e={time:+new Date,start:t._iDisplayStart,length:t._iDisplayLength,order:rG.extend(!0,[],t.aaSorting),search:a7(t.oPreviousSearch),columns:rG.map(t.aoColumns,function(e,i){return{visible:e.bVisible,search:a7(t.aoPreSearchCols[i])}})};t.oSavedState=e,oN(t,"aoStateSaveParams","stateSaveParams",[t,e]),t.oFeatures.bStateSave&&!t.bDestroying&&t.fnStateSaveCallback.call(t.oInstance,t,e)}}/**
 * Attempt to load a saved table state
 *  @param {object} oSettings dataTables settings object
 *  @param {object} oInit DataTables init object so we can override settings
 *  @param {function} callback Callback to execute when the state has been loaded
 *  @memberof DataTable#oApi
 */function oP(t,e,i){if(!t.oFeatures.bStateSave){i();return}var n=t.fnStateLoadCallback.call(t.oInstance,t,function(e){oL(t,e,i)});// otherwise, wait for the loaded callback to be executed
return void 0!==n&&oL(t,n,i),!0}function oL(t,e,i){var n,r,a=t.aoColumns;t._bLoadingState=!0;// When StateRestore was introduced the state could now be implemented at any time
// Not just initialisation. To do this an api instance is required in some places
var o=t._bInitComplete?new rK.Api(t):null;if(!e||!e.time){t._bLoadingState=!1,i();return}// Allow custom and plug-in manipulation functions to alter the saved data set and
// cancelling of loading by returning false
var s=oN(t,"aoStateLoadParams","stateLoadParams",[t,e]);if(-1!==rG.inArray(!1,s)){t._bLoadingState=!1,i();return}// Reject old data
...
t.oLoadedState=rG.extend(!0,{},e),void 0!==e.length&&(o?o.page.len(e.length):t._iDisplayLength=e.length),void 0!==e.start&&(null===o?(t._iDisplayStart=e.start,t.iInitDisplayStart=e.start):oh(t,e.start/t._iDisplayLength)),void 0!==e.order&&(t.aaSorting=[],rG.each(e.order,function(e,i){t.aaSorting.push(i[0]>=a.length?[0,i[1]]:i)})),void 0!==e.search&&rG.extend(t.oPreviousSearch,ot(e.search)),e.columns){for(n=0,r=e.columns.length;n<r;n++){var h=e.columns[n];void 0!==h.visible&&(o?o.column(n).visible(h.visible,!1):a[n].bVisible=h.visible),void 0!==h.search&&rG.extend(t.aoPreSearchCols[n],ot(h.search))}// If the api is defined then we need to adjust the columns once the visibility has been changed
o&&o.columns.adjust()}t._bLoadingState=!1,oN(t,"aoStateLoaded","stateLoaded",[t,e]),i()}/**
 * Return the settings object for a particular table
 *  @param {node} table table we are using as a dataTable
 *  @returns {object} Settings object - or null if not found
 *  @memberof DataTable#oApi
 */function oE(t){var e=rK.settings,i=rG.inArray(t,r7(e,"nTable"));return -1!==i?e[i]:null}/**
 ...
 *  @memberof DataTable#oApi
 */function oI(t,e,i,n){if(i="DataTables warning: "+(t?"table id="+t.sTableId+" - ":"")+i,n&&(i+=". For more information about this error, please see http://datatables.net/tn/"+n),e)window.console&&console.log&&console.log(i);else{// Backwards compatibility pre 1.10
var r=rK.ext,a=r.sErrMode||r.errMode;if(t&&oN(t,null,"error",[t,n,i]),"alert"==a)alert(i);else if("throw"==a)throw Error(i);else"function"==typeof a&&a(t,n,i)}}/**
 ...
 *  @memberof DataTable#oApi
 */function oO(t,e,i,n){if(Array.isArray(i)){rG.each(i,function(i,n){Array.isArray(n)?oO(t,e,n[0],n[1]):oO(t,e,n)});return}void 0===n&&(n=i),void 0!==e[i]&&(t[n]=e[i])}/**
 ...
 */function oR(t,e,i){var n;for(var r in e)e.hasOwnProperty(r)&&(n=e[r],rG.isPlainObject(n)?(rG.isPlainObject(t[r])||(t[r]={}),rG.extend(!0,t[r],n)):i&&"data"!==r&&"aaData"!==r&&Array.isArray(n)?t[r]=n.slice():t[r]=n);return t}/**
 ...
 *  @memberof DataTable#oApi
 */function oF(t,e,i){rG(t).on("click.DT",e,function(e){rG(t).trigger("blur"),i(e)}).on("keypress.DT",e,function(t){13===t.which&&(t.preventDefault(),i(t))}).on("selectstart.DT",function(){/* Take the brutal approach to cancelling text selection */return!1})}/**
 ...
 *  @memberof DataTable#oApi
 */function oj(t,e,i,n){i&&t[e].push({fn:i,sName:n})}/**
 ...
 *      trigger
 *  @memberof DataTable#oApi
 */function oN(t,e,i,n){var r=[];if(e&&(r=rG.map(t[e].slice().reverse(),function(e,i){return e.fn.apply(t.oInstance,n)})),null!==i){var a=rG.Event(i+".dt"),o=rG(t.nTable);o.trigger(a,n),0===o.parents("body").length&&rG("body").trigger(a,n),r.push(a.result)}return r}function oH(t){var e=t._iDisplayStart,i=t.fnDisplayEnd(),n=t._iDisplayLength;e>=i&&(e=i-n),// Keep the start record on the current page
e-=e%n,(-1===n||e<0)&&(e=0),t._iDisplayStart=e}function oW(t,e){var i=t.renderer,n=rK.ext.renderer[e];return rG.isPlainObject(i)&&i[e]?n[i[e]]||n._:"string"==typeof i&&n[i]||n._}/**
 ...
 *  @memberof DataTable#oApi
 */function oB(t){return t.oFeatures.bServerSide?"ssp":t.ajax||t.sAjaxSource?"ajax":"dom"}/**
 ...
 * @type {Array}
 * @ignore
 */var oz=[],oV=Array.prototype,o$=function(t){var e,i,n=rK.settings,r=rG.map(n,function(t,e){return t.nTable});return t?t.nTable&&t.oApi?[t]:t.nodeName&&"table"===t.nodeName.toLowerCase()?-1!==// Table node
(e=rG.inArray(t,r))?[n[e]]:null:t&&"function"==typeof t.settings?t.settings().toArray():("string"==typeof t?i=rG(t):t instanceof rG&&(i=t),i)?i.map(function(t){return -1!==(e=rG.inArray(this,r))?n[e]:null}).toArray():void 0:[]};/**
 ...
 */t5=function(t,e){if(!(this instanceof t5))return new t5(t,e);var i=[],n=function(t){var e=o$(t);e&&i.push.apply(i,e)};if(Array.isArray(t))for(var r=0,a=t.length;r<a;r++)n(t[r]);else n(t);// Remove duplicates
this.context=aa(i),e&&rG.merge(this,e),// selector
this.selector={rows:null,cols:null,opts:null},t5.extend(this,this,oz)},rK.Api=t5,// Don't destroy the existing prototype, just extend it. Required for jQuery 2's
// isPlainObject.
rG.extend(t5.prototype,{any:function(){return 0!==this.count()},concat:oV.concat,context:[],count:function(){return this.flatten().length},each:function(t){for(var e=0,i=this.length;e<i;e++)t.call(this,this[e],e,this);return this},eq:function(t){var e=this.context;return e.length>t?new t5(e[t],this[t]):null},filter:function(t){var e=[];if(oV.filter)e=oV.filter.call(this,t,this);else // Compatibility for browsers without EMCA-252-5 (JS 1.6)
for(var i=0,n=this.length;i<n;i++)t.call(this,this[i],i,this)&&e.push(this[i]);return new t5(this.context,e)},flatten:function(){var t=[];return new t5(this.context,t.concat.apply(t,this.toArray()))},join:oV.join,indexOf:oV.indexOf||function(t,e){for(var i=e||0,n=this.length;i<n;i++)if(this[i]===t)return i;return -1},iterator:function(t,e,i,n){var r,a,o,s,l,h,c,u,d=[],f=this.context,p=this.selector;for("string"==typeof t&&(n=i,i=e,e=t,t=!1),a=0,o=f.length;a<o;a++){var g=new t5(f[a]);if("table"===e)void 0!==(r=i.call(g,f[a],a))&&d.push(r);else if("columns"===e||"rows"===e)void 0!==// this has same length as context - one entry for each table
...
c=this[a],"column-rows"===e&&(h=oG(f[a],p.opts)),s=0,l=c.length;s<l;s++)u=c[s],void 0!==(r="cell"===e?i.call(g,f[a],u.row,u.column,a,s):i.call(g,f[a],u,a,s,h))&&d.push(r)}if(d.length||n){var m=new t5(f,t?d.concat.apply([],d):d),b=m.selector;return b.rows=p.rows,b.cols=p.cols,b.opts=p.opts,m}return this},lastIndexOf:oV.lastIndexOf||function(t,e){// Bit cheeky...
return this.indexOf.apply(this.toArray.reverse(),arguments)},length:0,map:function(t){var e=[];if(oV.map)e=oV.map.call(this,t,this);else for(var i=0,n=this.length;i<n;i++)e.push(t.call(this,this[i],i));return new t5(this.context,e)},pluck:function(t){var e=rK.util.get(t);return this.map(function(t){return e(t)})},pop:oV.pop,push:oV.push,// Does not return an API instance
reduce:oV.reduce||function(t,e){return ag(this,t,e,0,this.length,1)},reduceRight:oV.reduceRight||function(t,e){return ag(this,t,e,this.length-1,-1,-1)},reverse:oV.reverse,// Object with rows, columns and opts
selector:null,shift:oV.shift,slice:function(){return new t5(this.context,this)},sort:oV.sort,splice:oV.splice,toArray:function(){return oV.slice.call(this)},to$:function(){return rG(this)},toJQuery:function(){return rG(this)},unique:function(){return new t5(this.context,aa(this))},unshift:oV.unshift}),t5.extend=function(t,e,i){// Only extend API instances and static properties of the API
...
//       }
//     ]
t5.register=t3=function(t,e){if(Array.isArray(t)){for(var i=0,n=t.length;i<n;i++)t5.register(t[i],e);return}var r,a,o,s,l=t.split("."),h=oz;for(r=0,a=l.length;r<a;r++){var c=function(t,e){for(var i=0,n=t.length;i<n;i++)if(t[i].name===e)return t[i];return null}(h,o=(s=-1!==l[r].indexOf("()"))?l[r].replace("()",""):l[r]);c||(c={name:o,val:{},methodExt:[],propExt:[],type:"object"},h.push(c)),r===a-1?(c.val=e,c.type="function"==typeof e?"function":rG.isPlainObject(e)?"object":"other"):h=s?c.methodExt:c.propExt}},t5.registerPlural=t4=function(t,e,i){t5.register(t,i),t5.register(e,function(){var t=i.apply(this,arguments);return t===this?this:t instanceof t5?t.length?Array.isArray(t[0])?new t5(t.context,t[0]):t[0]:void 0:t})};/**
 ...
 * @return {array}
 * @ignore
 */var oq=function(t,e){if(Array.isArray(t))return rG.map(t,function(t){return oq(t,e)});// Integer is used to pick out a table by index
if("number"==typeof t)return[e[t]];// Perform a jQuery selector on the table nodes
var i=rG.map(e,function(t,e){return t.nTable});return rG(i).filter(t).map(function(t){return e[rG.inArray(this,i)]}).toArray()};/**
...
return null!=t?new t5(oq(t,this.context)):this}),t3("table()",function(t){var e=this.tables(t),i=e.context;// Truncate to the first matched table
 ...
 */t3("draw()",function(t){return this.iterator("table",function(e){"page"===t?aV(e):("string"==typeof t&&(t="full-hold"!==t),a$(e,!1===t))})}),/**
 ...
 */t3("page()",function(t){return void 0===t?this.page.info().page:this.iterator("table",function(e){oh(e,t)})// not an expensive call
}),/**
...
void 0===t?0!==this.context.length?this.context[0]._iDisplayLength:void 0:this.iterator("table",function(e){oo(e,t)}))});var oU=function(t,e,i){// Use the draw event to trigger a callback
if(i){var n=new t5(t);n.one("draw",function(){i(n.ajax.json())})}if("ssp"==oB(t))a$(t,e);else{ou(t,!0);// Cancel an existing request
var r=t.jqXHR;r&&4!==r.readyState&&r.abort(),// Trigger xhr
aY(t,[],function(i){aR(t);for(var n=aZ(t,i),r=0,a=n.length;r<a;r++)aC(t,n[r]);a$(t,e),ou(t,!1)})}};/**
 ...
 * @returns {DataTables.Api} this
 */t3("ajax.reload()",function(t,e){return this.iterator("table",function(i){oU(i,!1===e,t)})}),/**
...
if(0===e.length)return;return(e=e[0]).ajax?rG.isPlainObject(e.ajax)?e.ajax.url:e.ajax:e.sAjaxSource}// set
return this.iterator("table",function(e){rG.isPlainObject(e.ajax)?e.ajax.url=t:e.ajax=t;// No need to consider sAjaxSource here since DataTables gives priority
...
// url change
return this.iterator("table",function(i){oU(i,!1===e,t)})});var oX=function(t,e,i,n,r){var a,o,s,l,h,c,u=[],d=typeof e;for(e&&"string"!==d&&"function"!==d&&void 0!==e.length||(e=[e]),s=0,l=e.length;s<l;s++)for(h=0,c=// Only split on simple strings - complex expressions will be jQuery selectors
...
var f=t2.selector[t];if(f.length)for(s=0,l=f.length;s<l;s++)u=f[s](n,r,u);return aa(u)},oY=function(t){return t||(t={}),t.filter&&void 0===t.search&&(t.search=t.filter),rG.extend({search:"none",order:"current",page:"all"},t)},oJ=function(t){// Reduce the API instance to the first item found
...
t.length=0,t)},oG=function(t,e){var i,n,r,a=[],o=t.aiDisplay,s=t.aiDisplayMaster,l=e.search,h=e.order,c=e.page;if("ssp"==oB(t))// rows not shown don't exist and the index order is the applied order
// Removed is a special case - for consistency just return an empty
// array
return"removed"===l?[]:ae(0,s.length);if("current"==c)// fairly senseless otherwise, regardless of what order and search actually
// are
for(i=t._iDisplayStart,n=t.fnDisplayEnd();i<n;i++)a.push(o[i]);else if("current"==h||"applied"==h){if("none"==l)a=s.slice();else if("applied"==l)a=o.slice();else if("removed"==l){for(var u={},i=0,n=o.length;i<n;i++)u[o[i]]=null;a=rG.map(s,function(t){return u.hasOwnProperty(t)?null:t})}}else if("index"==h||"original"==h)for(i=0,n=t.aoData.length;i<n;i++)"none"==l?a.push(i):(-1===(r=rG.inArray(i,o))&&"removed"==l||r>=0&&"applied"==l)&&a.push(i);return a},oK=function(t,e,i){var n;return oX("row",e,function(e){var r=r4(e),a=t.aoData;// Short cut - selector is a number and no options provided (default is
// all records, so no need to check if the index is in there, since it
// must be - dev error if the index doesn't exist).
if(null!==r&&!i||(n||(n=oG(t,i)),null!==r&&-1!==rG.inArray(r,n)))return[r];if(null==e||""===e)return n;// Selector - function
if("function"==typeof e)return rG.map(n,function(t){var i=a[t];return e(t,i._aData,i.nTr)?t:null});// Selector - node
if(e.nodeName){var o=e._DT_RowIndex,s=e._DT_CellIndex;// Property added by DT for fast lookup
if(void 0!==o)return a[o]&&a[o].nTr===e?[o]:[];if(s)return a[s.row]&&a[s.row].nTr===e.parentNode?[s.row]:[];var l=rG(e).closest("*[data-dt-row]");return l.length?[l.data("dt-row")]:[]}// ID selector. Want to always be able to select rows by id, regardless
...
var c=ai(at(t.aoData,n,"nTr"));// Selector - jQuery selector string, array of nodes or jQuery object/
// As jQuery's .filter() allows jQuery objects to be passed in filter,
// it also allows arrays, so this will cope with all three options
return rG(c).filter(e).map(function(){return this._DT_RowIndex}).toArray()},t,i)};t3("rows()",function(t,e){void 0===t?t="":rG.isPlainObject(t)&&(e=t,t=""),e=oY(e);var i=this.iterator("table",function(i){return oK(i,t,e)},1);return(// Want argument shifting here and in __row_selector?
i.selector.rows=t,i.selector.opts=e,i)}),t3("rows().nodes()",function(){return this.iterator("row",function(t,e){return t.aoData[e].nTr||void 0},1)}),t3("rows().data()",function(){return this.iterator(!0,"rows",function(t,e){return at(t.aoData,e,"_aData")},1)}),t4("rows().cache()","row().cache()",function(t){return this.iterator("row",function(e,i){var n=e.aoData[i];return"search"===t?n._aFilterData:n._aSortData},1)}),t4("rows().invalidate()","row().invalidate()",function(t){return this.iterator("row",function(e,i){aj(e,i,t)})}),t4("rows().indexes()","row().index()",function(){return this.iterator("row",function(t,e){return e},1)}),t4("rows().ids()","row().id()",function(t){// `iterator` will drop undefined values, but in this case we want them
...
aF(e.aiDisplayMaster,i),aF(e.aiDisplay,i),aF(t[n],i,!1),e._iRecordsDisplay>0&&e._iRecordsDisplay--,// Check for an 'overflow' they case for displaying the table
oH(e);// Remove the row's ID reference if there is one
var d=e.rowIdFn(u._aData);void 0!==d&&delete e.aIds[d]}),this.iterator("table",function(t){for(var e=0,i=t.aoData.length;e<i;e++)t.aoData[e].idx=e}),this}),t3("rows.add()",function(t){var e=this.iterator("table",function(e){var i,n,r,a=[];for(n=0,r=t.length;n<r;n++)(i=t[n]).nodeName&&"TR"===i.nodeName.toUpperCase()?a.push(aT(e,i)[0]):a.push(aC(e,i));return a},1),i=this.rows(-1);return i.pop(),rG.merge(i,e),i}),/**
 *
 */t3("row()",function(t,e){return oJ(this.rows(t,e))}),t3("row().data()",function(t){var e=this.context;if(void 0===t)return e.length&&this.length?e[0].aoData[this[0]]._aData:void 0;// Set
var i=e[0].aoData[this[0]];return i._aData=t,Array.isArray(t)&&i.nTr&&i.nTr.id&&aI(e[0].rowId)(t,i.nTr.id),// Automatically invalidate
aj(e[0],this[0],"data"),this}),t3("row().node()",function(){var t=this.context;return t.length&&this.length&&t[0].aoData[this[0]].nTr||null}),t3("row.add()",function(t){// Allow a jQuery object to be passed in - only a single row is added from
// it though - the first element in the set
t instanceof rG&&t.length&&(t=t[0]);var e=this.iterator("table",function(e){return t.nodeName&&"TR"===t.nodeName.toUpperCase()?aT(e,t)[0]:aC(e,t)});// Return an Api.rows() extended instance, with the newly added row selected
return this.row(e[0])}),rG(document).on("plugin-init.dt",function(t,e){var i=new t5(e),n="on-plugin-init",r="stateSaveParams."+n,a="destroy. "+n;i.on(r,function(t,e,i){for(var n=e.rowIdFn,r=e.aoData,a=[],o=0;o<r.length;o++)r[o]._detailsShow&&a.push("#"+n(r[o]._aData));i.childRows=a}),i.on(a,function(){i.off(r+" "+a)});var o=i.state.loaded();o&&o.childRows&&i.rows(rG.map(o.childRows,function(t){return t.replace(/:/g,"\\:")})).every(function(){oN(e,null,"requestChild",[this])})});var oZ=function(t,e,i,n){// Convert to array of TR elements
var r=[],a=function(e,i){// Recursion to allow for arrays of jQuery objects
if(Array.isArray(e)||e instanceof rG){for(var n=0,o=e.length;n<o;n++)a(e[n],i);return}// If we get a TR element, then just add it directly - up to the dev
// to add the correct number of columns etc
if(e.nodeName&&"tr"===e.nodeName.toLowerCase())r.push(e);else{// Otherwise create a row with a wrapper
var s=rG("<tr><td></td></tr>").addClass(i);rG("td",s).addClass(i).html(e)[0].colSpan=a_(t),r.push(s[0])}};a(i,n),e._details&&e._details.detach(),e._details=rG(r),e._detailsShow&&e._details.insertAfter(e.nTr)},oQ=rK.util.throttle(function(t){oA(t[0])},500),o0=function(t,e){var i=t.context;if(i.length){var n=i[0].aoData[void 0!==e?e:t[0]];n&&n._details&&(n._details.remove(),n._detailsShow=void 0,n._details=void 0,rG(n.nTr).removeClass("dt-hasChild"),oQ(i))}},o1=function(t,e){var i=t.context;if(i.length&&t.length){var n=i[0].aoData[t[0]];n._details&&(n._detailsShow=e,e?(n._details.insertAfter(n.nTr),rG(n.nTr).addClass("dt-hasChild")):(n._details.detach(),rG(n.nTr).removeClass("dt-hasChild")),oN(i[0],null,"childRow",[e,t.row(t[0])]),o2(i[0]),oQ(i))}},o2=function(t){var e=new t5(t),i=".dt.DT_details",n="draw"+i,r="column-sizing"+i,a="destroy"+i,o=t.aoData;e.off(n+" "+r+" "+a),r7(o,"_details").length>0&&(// On each draw, insert the required elements into the document
...
e.on(r,function(e,i,n,r){if(t===i)for(var a,s=a_(i),l=0,h=o.length;l<h;l++)(a=o[l])._details&&a._details.children("td[colspan]").attr("colspan",s)}),// Table destroyed - nuke any child rows
e.on(a,function(i,n){if(t===n)for(var r=0,a=o.length;r<a;r++)o[r]._details&&o0(e,r)}))},o5="row().child",o3=o5+"()";// data can be:
//  tr
//  string
//  jQuery or array of any of the above
t3(o3,function(t,e){var i=this.context;return void 0===t?i.length&&this.length?i[0].aoData[this[0]]._details:void 0:(!0===t?this.child.show():!1===t?o0(this):i.length&&this.length&&oZ(i[0],i[0].aoData[this[0]],t,e),this)}),t3([o5+".show()",o3+".show()"// only when `child()` was called with parameters (without
],function(t){return o1(this,!0),this}),t3([o5+".hide()",o3+".hide()"// only when `child()` was called with parameters (without
],function(){return o1(this,!1),this}),t3([o5+".remove()",o3+".remove()"// only when `child()` was called with parameters (without
],function(){return o0(this),this}),t3(o5+".isShown()",function(){var t=this.context;return!!t.length&&!!this.length&&(t[0].aoData[this[0]]._detailsShow||!1)});/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Columns
 *
...
// separated lists
var o4=/^([^:]+):(name|visIdx|visible)$/,o8=function(t,e,i,n,r){for(var a=[],o=0,s=r.length;o<s;o++)a.push(ak(t,r[o],e));return a},o6=function(t,e,i){var n=t.aoColumns,r=r7(n,"sName"),a=r7(n,"nTh");return oX("column",e,function(e){var o=r4(e);// Selector - all
if(""===e)return ae(n.length);// Selector - index
if(null!==o)return[o>=0?o:n.length+o// Count from right (+ because its a negative value)
];// Selector = function
if("function"==typeof e){var s=oG(t,i);return rG.map(n,function(i,n){return e(n,o8(t,n,0,0,s),a[n])?n:null})}// jQuery or string selector
var l="string"==typeof e?e.match(o4):"";if(l)switch(l[2]){case"visIdx":case"visible":var h=parseInt(l[1],10);// Visible index given, convert to column index
if(h<0){// Counting from the right
var c=rG.map(n,function(t,e){return t.bVisible?e:null});return[c[c.length+h]]}// Counting from the left
return[ay(t,h)];case"name":// match by name. `names` is column index complete and in order
return rG.map(r,function(t,e){return t===l[1]?e:null});default:return[]}// Cell in the table body
if(e.nodeName&&e._DT_CellIndex)return[e._DT_CellIndex.column];// jQuery selector on the TH elements for the columns
var u=rG(a).filter(e).map(function(){return rG.inArray(this,a);// `nodes` is column index complete and in order
}).toArray();if(u.length||!e.nodeName)return u;// Otherwise a node which might have a `dt-column` data attribute, or be
// a child or such an element
var d=rG(e).closest("*[data-dt-column]");return d.length?[d.data("dt-column")]:[]},t,i)},o9=function(t,e,i){var n,r,a,o,s=t.aoColumns,l=s[e],h=t.aoData;// Get
if(void 0===i)return l.bVisible;// Set
// No change
if(l.bVisible!==i){if(i){// Insert column
// Need to decide if we should use appendChild or insertBefore
var c=rG.inArray(!0,r7(s,"bVisible"),e+1);for(r=0,a=h.length;r<a;r++)o=h[r].nTr,n=h[r].anCells,o&&o.insertBefore(n[e],n[c]||null)}else rG(r7(t.aoData,"anCells",e)).detach();// Common actions
l.bVisible=i}};t3("columns()",function(t,e){void 0===t?t="":rG.isPlainObject(t)&&(e=t,t=""),e=oY(e);var i=this.iterator("table",function(i){return o6(i,t,e)},1);return(// Want argument shifting here and in _row_selector?
i.selector.cols=t,i.selector.opts=e,i)}),t4("columns().header()","column().header()",function(t,e){return this.iterator("column",function(t,e){return t.aoColumns[e].nTh},1)}),t4("columns().footer()","column().footer()",function(t,e){return this.iterator("column",function(t,e){return t.aoColumns[e].nTf},1)}),t4("columns().data()","column().data()",function(){return this.iterator("column-rows",o8,1)}),t4("columns().dataSrc()","column().dataSrc()",function(){return this.iterator("column",function(t,e){return t.aoColumns[e].mData},1)}),t4("columns().cache()","column().cache()",function(t){return this.iterator("column-rows",function(e,i,n,r,a){return at(e.aoData,a,"search"===t?"_aFilterData":"_aSortData",i)},1)}),t4("columns().nodes()","column().nodes()",function(){return this.iterator("column-rows",function(t,e,i,n,r){return at(t.aoData,r,"anCells",e)},1)}),t4("columns().visible()","column().visible()",function(t,e){var i=this,n=this.iterator("column",function(e,i){if(void 0===t)return e.aoColumns[i].bVisible;// else
o9(e,i,t)});return void 0!==t&&this.iterator("table",function(n){// Redraw the header after changes
az(n,n.aoHeader),az(n,n.aoFooter),n.aiDisplay.length||rG(n.nTBody).find("td[colspan]").attr("colspan",a_(n)),oA(n),// Second loop once the first is done for events
i.iterator("column",function(i,n){oN(i,null,"column-visibility",[i,n,t,e])}),(void 0===e||e)&&i.columns.adjust()}),n}),t4("columns().indexes()","column().index()",function(t){return this.iterator("column",function(e,i){return"visible"===t?ax(e,i):i},1)}),t3("columns.adjust()",function(){return this.iterator("table",function(t){av(t)},1)}),t3("column.index()",function(t,e){if(0!==this.context.length){var i=this.context[0];if("fromVisible"===t||"toData"===t)return ay(i,e);if("fromData"===t||"toVisible"===t)return ax(i,e)}}),t3("column()",function(t,e){return oJ(this.columns(t,e))});var o7=function(t,e,i){var n,r,a,o,s,l,h,c=t.aoData,u=oG(t,i),d=ai(at(c,u,"anCells")),f=rG(ao([],d)),p=t.aoColumns.length;return oX("cell",e,function(e){var i="function"==typeof e;if(null==e||i){for(a=0,// All cells and function selectors
r=[],o=u.length;a<o;a++)for(s=0,n=u[a];s<p;s++)l={row:n,column:s},i?(// Selector - function
h=c[n],e(l,ak(t,n,s),h.anCells?h.anCells[s]:null)&&r.push(l)):r.push(l);return r}// Selector - index
if(rG.isPlainObject(e))return void 0!==e.column&&void 0!==e.row&&-1!==rG.inArray(e.row,u)?[e]:[];// Selector - jQuery filtered cells
...
// data attributes
(h=rG(e).closest("*[data-dt-row]")).length?[{row:h.data("dt-row"),column:h.data("dt-column")}]:[]},t,i)};t3("cells()",function(t,e,i){// Cell selector
if(rG.isPlainObject(t)&&(void 0===t.row?(// Selector options in first parameter
i=t,t=null):(// Cell index objects in first parameter
i=e,e=null)),rG.isPlainObject(e)&&(i=e,e=null),null==e)return this.iterator("table",function(e){return o7(e,t,oY(i))});// The default built in options need to apply to row and columns
var n,r,a,o,s=i?{page:i.page,order:i.order,search:i.search}:{},l=this.columns(e,s),h=this.rows(t,s),c=this.iterator("table",function(t,e){var i=[];for(n=0,r=h[e].length;n<r;n++)for(a=0,o=l[e].length;a<o;a++)i.push({row:h[e][n],column:l[e][a]});return i},1),u=i&&i.selected?this.cells(c,i):c;return rG.extend(u.selector,{cols:e,rows:t,opts:i}),u}),t4("cells().nodes()","cell().node()",function(){return this.iterator("cell",function(t,e,i){var n=t.aoData[e];return n&&n.anCells?n.anCells[i]:void 0},1)}),t3("cells().data()",function(){return this.iterator("cell",function(t,e,i){return ak(t,e,i)},1)}),t4("cells().cache()","cell().cache()",function(t){return t="search"===t?"_aFilterData":"_aSortData",this.iterator("cell",function(e,i,n){return e.aoData[i][t][n]},1)}),t4("cells().render()","cell().render()",function(t){return this.iterator("cell",function(e,i,n){return ak(e,i,n,t)},1)}),t4("cells().indexes()","cell().index()",function(){return this.iterator("cell",function(t,e,i){return{row:e,column:i,columnVisible:ax(t,i)}},1)}),t4("cells().invalidate()","cell().invalidate()",function(t){return this.iterator("cell",function(e,i,n){aj(e,i,t,n)})}),t3("cell()",function(t,e,i){return oJ(this.cells(t,e,i))}),t3("cell().data()",function(t){var e=this.context,i=this[0];return void 0===t?e.length&&i.length?ak(e[0],i[0].row,i[0].column):void 0:(// Set
aM(e[0],i[0].row,i[0].column,t),aj(e[0],i[0].row,"data",i[0].column),this)}),/**
 ...
 * @returns {DataTables.Api} this
 */t3("order.listener()",function(t,e,i){return this.iterator("table",function(n){oT(n,t,e,i)})}),t3("order.fixed()",function(t){if(!t){var e=this.context,i=e.length?e[0].aaSortingFixed:void 0;return Array.isArray(i)?{pre:i}:i}return this.iterator("table",function(e){e.aaSortingFixed=rG.extend(!0,{},t)})}),// Order by the selected column(s)
t3(["columns().order()","column().order()"],function(t){var e=this;return this.iterator("table",function(i,n){var r=[];rG.each(e[n],function(e,i){r.push([i,t])}),i.aaSorting=r})}),t3("search()",function(t,e,i,n){var r=this.context;return void 0===t?0!==r.length?r[0].oPreviousSearch.sSearch:void 0:this.iterator("table",function(r){r.oFeatures.bFilter&&a0(r,rG.extend({},r.oPreviousSearch,{sSearch:t+"",bRegex:null!==e&&e,bSmart:null===i||i,bCaseInsensitive:null===n||n}),1)})}),t4("columns().search()","column().search()",function(t,e,i,n){return this.iterator("column",function(r,a){var o=r.aoPreSearchCols;if(void 0===t)return o[a].sSearch;// set
r.oFeatures.bFilter&&(rG.extend(o[a],{sSearch:t+"",bRegex:null!==e&&e,bSmart:null===i||i,bCaseInsensitive:null===n||n}),a0(r,r.oPreviousSearch,1))})}),/*
 * State API methods
...
t.fnStateSaveCallback.call(t.oInstance,t,{})})}),t3("state.loaded()",function(){return this.context.length?this.context[0].oLoadedState:null}),t3("state.save()",function(){return this.iterator("table",function(t){oA(t)})}),/**
 * Set the jQuery or window object to be used by DataTables
 *
 * @param {*} module Library / container object
 * @param {string} [type] Library or container type `lib`, `win` or `datetime`.
 *   If not provided, automatic detection is attempted.
 */rK.use=function(t,e){"lib"===e||t.fn?rG=t:"win"==e||t.document?(window=t,document=t.document):("datetime"===e||"DateTime"===t.type)&&(rK.DateTime=t)},/**
 ...
 */rK.factory=function(t,e){var i=!1;return t&&t.document&&(window=t,document=t.document),e&&e.fn&&e.fn.jquery&&(rG=e,i=!0),i},/**
 ...
 */rK.versionCheck=rK.fnVersionCheck=function(t){for(var e,i,n=rK.version.split("."),r=t.split("."),a=0,o=r.length;a<o;a++)// Parts are the same, keep comparing
 ...
 *      $('#example').dataTable();
 *    }
 */rK.isDataTable=rK.fnIsDataTable=function(t){var e=rG(t).get(0),i=!1;return t instanceof rK.Api||(rG.each(rK.settings,function(t,n){var r=n.nScrollHead?rG("table",n.nScrollHead)[0]:null,a=n.nScrollFoot?rG("table",n.nScrollFoot)[0]:null;(n.nTable===e||r===e||a===e)&&(i=!0)}),i)},/**
 ...
 *    } );
 */rK.tables=rK.fnTables=function(t){var e=!1;rG.isPlainObject(t)&&(e=t.api,t=t.visible);var i=rG.map(rK.settings,function(e){if(!t||t&&rG(e.nTable).is(":visible"))return e.nTable});return e?new t5(i):i},/**
 ...
 *    Hungarian value in the `user` object will be overwritten. Otherwise they
 *    won't be.
 */rK.camelToHungarian=ah,/**
 *
 */t3("$()",function(t,e){var i=this.rows(e).nodes(),n=rG(i);return rG([].concat(n.filter(t).toArray(),n.find(t).toArray()))}),// jQuery functions to operate on the tables
rG.each(["on","one","off"],function(t,e){t3(e+"()",function(){var t=Array.prototype.slice.call(arguments);// Add the `dt` namespace automatically if it isn't already present
t[0]=rG.map(t[0].split(/\s/),function(t){return t.match(/\.dt\b/)?t:t+".dt"}).join(" ");var i=rG(this.tables().nodes());return i[e].apply(i,t),this})}),t3("clear()",function(){return this.iterator("table",function(t){aR(t)})}),t3("settings()",function(){return new t5(this.context,this.context)}),t3("init()",function(){var t=this.context;return t.length?t[0].oInit:null}),t3("data()",function(){return this.iterator("table",function(t){return r7(t.aoData,"_aData")}).flatten()}),t3("destroy()",function(t){return t=t||!1,this.iterator("table",function(e){var i,n=e.oClasses,r=e.nTable,a=e.nTBody,o=e.nTHead,s=e.nTFoot,l=rG(r),h=rG(a),c=rG(e.nTableWrapper),u=rG.map(e.aoData,function(t){return t.nTr});// Flag to note that the table is currently being destroyed - no action
// should be taken
e.bDestroying=!0,// Fire off the destroy callbacks for plug-ins etc
oN(e,"aoDestroyCallback","destroy",[e]),t||new t5(e).columns().visible(!0),// Blitz all `DT` namespaced events (these are internal events, the
// lowercase, `dt` events are user subscribed and they are responsible
// for removing them
c.off(".DT").find(":not(tbody *)").off(".DT"),rG(window).off(".DT-"+e.sInstance),r!=o.parentNode&&(l.children("thead").detach(),l.append(o)),s&&r!=s.parentNode&&(l.children("tfoot").detach(),l.append(s)),e.aaSorting=[],e.aaSortingFixed=[],ok(e),rG(u).removeClass(e.asStripeClasses.join(" ")),rG("th, td",o).removeClass(n.sSortable+" "+n.sSortableAsc+" "+n.sSortableDesc+" "+n.sSortableNone),// Add the TR elements back into the table in their original order
...
(i=e.asDestroyStripes.length)&&h.children().each(function(t){rG(this).addClass(e.asDestroyStripes[t%i])}));/* Remove the settings object from the settings array */var p=rG.inArray(e,rK.settings);-1!==p&&rK.settings.splice(p,1)})}),// Add the `every()` method for rows, columns and cells in a compact form
rG.each(["column","row","cell"],function(t,e){t3(e+"s().every()",function(t){var i=this.selector.opts,n=this;return this.iterator(e,function(r,a,o,s,l){// Rows and columns:
//  arg1 - index
//  arg2 - table counter
//  arg3 - loop counter
//  arg4 - undefined
...
// DataTable
t3("i18n()",function(t,e,i){var n=this.context[0],r=aE(t)(n.oLanguage);return void 0===r&&(r=e),void 0!==i&&rG.isPlainObject(r)&&(r=void 0!==r[i]?r[i]:r._),"string"==typeof r?r.replace("%d",i)// nb: plural might be undefined,
:r}),/**
 ...
 */rK.defaults={/**
	 ...
	 *      } );
	 *    } )
	 */oSearch:rG.extend({},rK.models.oSearch),/**
	 * __Deprecated__ The functionality provided by this parameter has now been
	 * superseded by that provided through `ajax`, which should be used instead.
	 *
 ...
 */rK.defaults.column={/**
	 ...
	 *      } );
	 *    } );
	 */sWidth:null},al(rK.defaults.column),/**
 ...
 */rK.models.oSettings={/**
	 ...
	 *  @type function
	 */fnRecordsTotal:function(){return"ssp"==oB(this)?1*this._iRecordsTotal:this.aiDisplayMaster.length},/**
	 * Get the number of records in the current record set, after filtering
	 *  @type function
	 */fnRecordsDisplay:function(){return"ssp"==oB(this)?1*this._iRecordsDisplay:this.aiDisplay.length},/**
...
/**
	 ...
	 */fnVersionCheck:rK.fnVersionCheck,/**
...
//
rG.extend(t2,{afnFiltering:t2.search,aTypes:t2.type.detect,ofnSearch:t2.type.search,oSort:t2.type.order,afnSortData:t2.order,aoFeatures:t2.feature,oApi:t2.internal,oStdClasses:t2.classes,oPagination:t2.pager}),rG.extend(rK.ext.classes,{sTable:"dataTable",sNoFooter:"no-footer",/* Paging buttons */sPageButton:"paginate_button",sPageButtonActive:"current",sPageButtonDisabled:"disabled",/* Striping classes */sStripeOdd:"odd",sStripeEven:"even",/* Empty row */sRowEmpty:"dataTables_empty",/* Features */sWrapper:"dataTables_wrapper",sFilter:"dataTables_filter",sInfo:"dataTables_info",sPaging:"dataTables_paginate paging_",/* Note that the type is postfixed */sLength:"dataTables_length",sProcessing:"dataTables_processing",/* Sorting */sSortAsc:"sorting_asc",sSortDesc:"sorting_desc",sSortable:"sorting",/* Sortable in both directions */sSortableAsc:"sorting_desc_disabled",sSortableDesc:"sorting_asc_disabled",sSortableNone:"sorting_disabled",sSortColumn:"sorting_",/* Note that an int is postfixed for the sorting order *//* Filtering */sFilterInput:"",/* Page length */sLengthSelect:"",/* Scrolling */sScrollWrapper:"dataTables_scroll",sScrollHead:"dataTables_scrollHead",sScrollHeadInner:"dataTables_scrollHeadInner",sScrollBody:"dataTables_scrollBody",sScrollFoot:"dataTables_scrollFoot",sScrollFootInner:"dataTables_scrollFootInner",/* Misc */sHeaderTH:"",sFooterTH:"",// Deprecated
sSortJUIAsc:"",sSortJUIDesc:"",sSortJUI:"",sSortJUIAscAllowed:"",sSortJUIDescAllowed:"",sSortJUIWrapper:"",sSortIcon:"",sJUIHeader:"",sJUIFooter:""});var st=rK.ext.pager;function se(t,e){var i=[],n=st.numbers_length,r=Math.floor(n/2);return e<=n?i=ae(0,e):t<=r?((i=ae(0,n-2)).push("ellipsis"),i.push(e-1)):(t>=e-1-r?(i=ae(e-(n-2),e)).splice(0,0,"ellipsis"):((i=ae(t-r+2,t+r-1)).push("ellipsis"),i.push(e-1),i.splice(0,0,"ellipsis")),i.splice(0,0,0)),i.DT_el="span",i}rG.extend(st,{simple:function(t,e){return["previous","next"]},full:function(t,e){return["first","previous","next","last"]},numbers:function(t,e){return[se(t,e)]},simple_numbers:function(t,e){return["previous",se(t,e),"next"]},full_numbers:function(t,e){return["first","previous",se(t,e),"next","last"]},first_last_numbers:function(t,e){return["first",se(t,e),"last"]},// For testing and plug-ins to use
_numbers:se,// Number of number buttons (including ellipsis) to show. _Must be odd!_
numbers_length:7}),rG.extend(!0,rK.ext.renderer,{pageButton:{_:function(t,e,i,n,r,a){var o,s,l,h=t.oClasses,c=t.oLanguage.oPaginate,u=t.oLanguage.oAria.paginate||{},d=function(e,n){var l,f,p,g,m=h.sPageButtonDisabled,b=function(e){oh(t,e.data.action,!0)};for(l=0,f=n.length;l<f;l++)if(Array.isArray(p=n[l]))d(rG("<"+(p.DT_el||"div")+"/>").appendTo(e),p);else{switch(o=null,s=p,g=t.iTabIndex,p){case"ellipsis":e.append('<span class="ellipsis">&#x2026;</span>');break;case"first":o=c.sFirst,0===r&&(g=-1,s+=" "+m);break;case"previous":o=c.sPrevious,0===r&&(g=-1,s+=" "+m);break;case"next":o=c.sNext,(0===a||r===a-1)&&(g=-1,s+=" "+m);break;case"last":o=c.sLast,(0===a||r===a-1)&&(g=-1,s+=" "+m);break;default:o=t.fnFormatNumber(p+1),s=r===p?h.sPageButtonActive:""}if(null!==o){var v=t.oInit.pagingTag||"a",y=-1!==s.indexOf(m);oF(rG("<"+v+">",{class:h.sPageButton+" "+s,"aria-controls":t.sTableId,"aria-disabled":y?"true":null,"aria-label":u[p],role:"link","aria-current":s===h.sPageButtonActive?"page":null,"data-dt-idx":p,tabindex:g,id:0===i&&"string"==typeof p?t.sTableId+"_"+p:null}).html(o).appendTo(e),{action:p},b)}}};try{// Because this approach is destroying and recreating the paging
// elements, focus is lost on the select button which is bad for
// accessibility. So we want to restore focus once the draw has
// completed
l=rG(e).find(document.activeElement).data("dt-idx")}catch(t){}d(rG(e).empty(),n),void 0!==l&&rG(e).find("[data-dt-idx="+l+"]").trigger("focus")}}}),// Built in type detection. See model.ext.aTypes for information about
// what is required from this methods.
rG.extend(rK.ext.type.detect,[// Plain numbers - first since V8 detects some plain numbers as dates
// e.g. Date.parse('55') (but not all, e.g. Date.parse('22')...).
function(t,e){var i=e.oLanguage.sDecimal;return r6(t,i)?"num"+i:null},// Dates (only those recognised by the browser's Date.parse)
function(t,e){// V8 tries _very_ hard to make a string passed into `Date.parse()`
// valid, so we need to use a regex to restrict date formats. Use a
// plug-in for anything other than ISO8601 style strings
if(t&&!(t instanceof Date)&&!r1.test(t))return null;var i=Date.parse(t);return null!==i&&!isNaN(i)||r3(t)?"date":null},// Formatted numbers
function(t,e){var i=e.oLanguage.sDecimal;return r6(t,i,!0)?"num-fmt"+i:null},// HTML numeric
function(t,e){var i=e.oLanguage.sDecimal;return r9(t,i)?"html-num"+i:null},// HTML numeric, formatted
function(t,e){var i=e.oLanguage.sDecimal;return r9(t,i,!0)?"html-num-fmt"+i:null},// HTML (this is strict checking - there must be html)
function(t,e){return r3(t)||"string"==typeof t&&-1!==t.indexOf("<")?"html":null}]),// Filter formatting functions. See model.ext.ofnSearch for information about
// what is required from these methods.
// 
// Note that additional search methods are added for the html numbers and
// html formatted numbers by `_addNumericSort()` when we know what the decimal
// place is
rG.extend(rK.ext.type.search,{html:function(t){return r3(t)?t:"string"==typeof t?t.replace(rQ," ").replace(r0,""):""},string:function(t){return r3(t)?t:"string"==typeof t?t.replace(rQ," "):t}});var si=function(t,e,i,n){if(0!==t&&(!t||"-"===t))return-1/0;var r=typeof t;return"number"===r||"bigint"===r?t:(e&&(t=r8(t,e)),t.replace&&(i&&(t=t.replace(i,"")),n&&(t=t.replace(n,""))),1*t)};// Add the numeric 'deformatting' functions for sorting and search. This is done
// in a function to provide an easy ability for the language options to add
// additional methods if a non-period decimal place is used.
function sn(t){rG.each({// Plain numbers
num:function(e){return si(e,t)},// Formatted numbers
"num-fmt":function(e){return si(e,t,r5)},// HTML numeric
"html-num":function(e){return si(e,t,r0)},// HTML numeric, formatted
"html-num-fmt":function(e){return si(e,t,r0,r5)}},function(e,i){// Add the ordering method
t2.type.order[e+t+"-pre"]=i,e.match(/^html\-/)&&(t2.type.search[e+t]=t2.type.search.html)})}// Default sort methods
rG.extend(t2.type.order,{// Dates
"date-pre":function(t){var e=Date.parse(t);return isNaN(e)?-1/0:e},// html
"html-pre":function(t){return r3(t)?"":t.replace?t.replace(/<.*?>/g,"").toLowerCase():t+""},// string
"string-pre":function(t){// This is a little complex, but faster than always calling toString,
// http://jsperf.com/tostring-v-check
return r3(t)?"":"string"==typeof t?t.toLowerCase():t.toString?t.toString():""},// string-asc and -desc are retained only for compatibility with the old
// sort methods
...
sn(""),rG.extend(!0,rK.ext.renderer,{header:{_:function(t,e,i,n){// No additional mark-up required
// Attach a sort listener to update on sort - note that using the
// `DT` namespace will allow the event to be removed automatically
// on destroy, while the `dt` namespaced event is the one we are
// listening for
rG(t.nTable).on("order.dt.DT",function(r,a,o,s){if(t===a){var l=i.idx;e.removeClass(n.sSortAsc+" "+n.sSortDesc).addClass("asc"==s[l]?n.sSortAsc:"desc"==s[l]?n.sSortDesc:i.sSortingClass)}// table, not a nested one
})},jqueryui:function(t,e,i,n){rG("<div/>").addClass(n.sSortJUIWrapper).append(e.contents()).append(rG("<span/>").addClass(n.sSortIcon+" "+i.sSortingClassJUI)).appendTo(e),// Attach a sort listener to update on sort
rG(t.nTable).on("order.dt.DT",function(r,a,o,s){if(t===a){var l=i.idx;e.removeClass(n.sSortAsc+" "+n.sSortDesc).addClass("asc"==s[l]?n.sSortAsc:"desc"==s[l]?n.sSortDesc:i.sSortingClass),e.find("span."+n.sSortIcon).removeClass(n.sSortJUIAsc+" "+n.sSortJUIDesc+" "+n.sSortJUI+" "+n.sSortJUIAscAllowed+" "+n.sSortJUIDescAllowed).addClass("asc"==s[l]?n.sSortJUIAsc:"desc"==s[l]?n.sSortJUIDesc:i.sSortingClassJUI)}})}}});/*
 * Public helper functions. These aren't used internally by DataTables, or
 * called by any of the options passed into DataTables, but they can be used
 * externally by developers working with DataTables. They are helper functions
 * to make working with DataTables a little bit easier.
 */var sr=function(t){return Array.isArray(t)&&(t=t.join(",")),"string"==typeof t?t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):t};// Common logic for moment, luxon or a date action
function sa(t,e,i,n,r){return window.moment?t[e](r):window.luxon?t[i](r):n?t[n](r):t}var so=!1;function ss(t,e,i){var n;if(window.moment){if(!(n=window.moment.utc(t,e,i,!0)).isValid())return null}else if(window.luxon){if(!(n=e&&"string"==typeof t?window.luxon.DateTime.fromFormat(t,e):window.luxon.DateTime.fromISO(t)).isValid)return null;n.setLocale(i)}else e?(so||alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),so=!0):n=new Date(t);return n}// Wrapper for date, datetime and time which all operate the same way with the exception of
// the output string for auto locale support
function sl(t){return function(e,i,n,r){0==arguments.length?(n="en",i=null,e=null):1==arguments.length?(n="en",i=e,e=null):2==arguments.length&&(n=i,i=e,e=null);var a="datetime-"+i;return rK.ext.type.order[a]||(// The renderer will give the value to type detect as the type!
rK.ext.type.detect.unshift(function(t){return t===a&&a}),// The renderer gives us Moment, Luxon or Date obects for the sorting, all of which have a
// `valueOf` which gives milliseconds epoch
rK.ext.type.order[a+"-asc"]=function(t,e){var i=t.valueOf(),n=e.valueOf();return i===n?0:i<n?-1:1},rK.ext.type.order[a+"-desc"]=function(t,e){var i=t.valueOf(),n=e.valueOf();return i===n?0:i>n?-1:1}),function(o,s){// Allow for a default value
if(null==o){if("--now"===r){// We treat everything as UTC further down, so no changes are
// made, as such need to get the local date / time as if it were
// UTC
var l=new Date;o=new Date(Date.UTC(l.getFullYear(),l.getMonth(),l.getDate(),l.getHours(),l.getMinutes(),l.getSeconds()))}else o=""}if("type"===s)return a;if(""===o)return"sort"!==s?"":ss("0000-01-01 00:00:00",null,n);// Shortcut. If `from` and `to` are the same, we are using the renderer to
// format for ordering, not display - its already in the display format.
if(null!==i&&e===i&&"sort"!==s&&"type"!==s&&!(o instanceof Date))return o;var h=ss(o,e,n);if(null===h)return o;if("sort"===s)return h;var c=null===i?sa(h,"toDate","toJSDate","")[t]():sa(h,"format","toFormat","toISOString",i);// XSS protection
return"display"===s?sr(c):c}}}// Based on locale, determine standard number formatting
// Fallback for legacy browsers is US English
var sh=",",sc=".";if(void 0!==window.Intl)try{for(var su=new Intl.NumberFormat().formatToParts(100000.1),sd=0;sd<su.length;sd++)"group"===su[sd].type?sh=su[sd].value:"decimal"===su[sd].type&&(sc=su[sd].value)}catch(t){// noop
}/*
 ...
 */function sf(t){return function(){var e=[oE(this[rK.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));return rK.ext.internal[t].apply(this,e)}}// Formatted date time detection - use by declaring the formats you are going to use
rK.datetime=function(t,e){var i="datetime-detect-"+t;e||(e="en"),rK.ext.type.order[i]||(rK.ext.type.detect.unshift(function(n){var r=ss(n,t,e);return(""===n||!!r)&&i}),rK.ext.type.order[i+"-pre"]=function(i){return ss(i,t,e)||0})},/**
 ...
 *
 * @namespace
 */rK.render={date:sl("toLocaleDateString"),datetime:sl("toLocaleString"),time:sl("toLocaleTimeString"),number:function(t,e,i,n,r){return null==t&&(t=sh),null==e&&(e=sc),{display:function(a){if("number"!=typeof a&&"string"!=typeof a||""===a||null===a)return a;var o=a<0?"-":"",s=parseFloat(a);// If NaN then there isn't much formatting that we can do - just
// return immediately, escaping any HTML (this was supposed to
// be a number after all)
if(isNaN(s))return sr(a);var l=parseInt(a=Math.abs(s=s.toFixed(i)),10),h=i?e+(a-l).toFixed(i).substring(2):"";return 0===l&&0===parseFloat(h)&&(o=""),o+(n||"")+l.toString().replace(/\B(?=(\d{3})+(?!\d))/g,t)+h+(r||"")}}},text:function(){return{display:sr,filter:sr}}},/**
 * Reference to internal functions for use by plug-in developers. Note that
 * these methods are references to internal functions and are considered to be
 * private. If you use these methods, be aware that they are liable to change
 * between versions.
 *  @namespace
 */rG.extend(rK.ext.internal,{_fnExternApiFunc:sf,_fnBuildAjax:aY,_fnAjaxUpdate:aJ,_fnAjaxParameters:aG,_fnAjaxUpdateDraw:aK,_fnAjaxDataSrc:aZ,_fnAddColumn:am,_fnColumnOptions:ab,_fnAdjustColumnSizing:av,_fnVisibleToColumnIndex:ay,_fnColumnIndexToVisible:ax,_fnVisbleColumns:a_,_fnGetColumns:aw,_fnColumnTypes:aS,_fnApplyColumnDefs:aD,_fnHungarianMap:al,_fnCamelToHungarian:ah,_fnLanguageCompat:ac,_fnBrowserDetect:ap,_fnAddData:aC,_fnAddTr:aT,_fnNodeToDataIndex:/**
 ...
 *  @memberof DataTable#oApi
 */function(t,e,i){return rG.inArray(i,t.aoData[e].anCells)},_fnGetCellData:ak,_fnSetCellData:aM,_fnSplitObjNotation:aL,_fnGetObjectDataFn:aE,_fnSetObjectDataFn:aI,_fnGetDataMaster:aO,_fnClearTable:aR,_fnDeleteIndex:aF,_fnInvalidate:aj,_fnGetRowElements:aN,_fnCreateTr:aH,_fnBuildHead:aB,_fnDrawHead:az,_fnDraw:aV,_fnReDraw:a$,_fnAddOptionsHtml:aq,_fnDetectHeader:aU,_fnGetUniqueThs:aX,_fnFeatureHtmlFilter:aQ,_fnFilterComplete:a0,_fnFilterCustom:a1,_fnFilterColumn:a2,_fnFilter:a5,_fnFilterCreateSearch:a3,_fnEscapeRegex:a4,_fnFilterData:a9,_fnFeatureHtmlInfo:oe,_fnUpdateInfo:oi,_fnInfoMacros:on,_fnInitialise:or,_fnInitComplete:oa,_fnLengthChange:oo,_fnFeatureHtmlLength:os,_fnFeatureHtmlPaginate:ol,_fnPageChange:oh,_fnFeatureHtmlProcessing:oc,_fnProcessingDisplay:ou,_fnFeatureHtmlTable:od,_fnScrollDraw:of,_fnApplyToChildren:op,_fnCalculateColumnWidths:om,_fnThrottle:ob,_fnConvertToWidth:ov,_fnGetWidestNode:oy,_fnGetMaxLenString:ox,_fnStringToCss:o_,_fnSortFlatten:ow,_fnSort:oS,_fnSortAria:oD,_fnSortListener:oC,_fnSortAttachListener:oT,_fnSortingClasses:ok,_fnSortData:oM,_fnSaveState:oA,_fnLoadState:oP,_fnImplementState:oL,_fnSettingsFromNode:oE,_fnLog:oI,_fnMap:oO,_fnBindAction:oF,_fnCallbackReg:oj,_fnCallbackFire:oN,_fnLengthOverflow:oH,_fnRenderer:oW,_fnDataSource:oB,_fnRowAttributes:aW,_fnExtend:oR,_fnCalculateEnd:function(){}// Used by a lot of plug-ins, but redundant
}),// jQuery access
rG.fn.dataTable=rK,// Provide access to the host jQuery object (circular reference)
rK.$=rG,// Legacy aliases
rG.fn.dataTableSettings=rK.settings,rG.fn.dataTableExt=rK.ext,// With a capital `D` we return a DataTables API instance rather than a
// jQuery object
rG.fn.DataTable=function(t){return rG(this).dataTable(t).api()},// All properties that are available to $.fn.dataTable should also be
// available on $.fn.DataTable
rG.each(rK,function(t,e){rG.fn.DataTable[t]=e});// Allow reassignment of the $ variable
let sp=/*@__PURE__*/a(rJ);function sg(t){return t.replaceAll(/(https?:\/\/)/g,"").replaceAll(/(-|\/|:|\.|#)/g,"-")}/**
 ...
 *//* Set the defaults for DataTables initialisation */sp.extend(!0,rK.defaults,{dom:"<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",renderer:"bootstrap"}),/* Default class modification */sp.extend(rK.ext.classes,{sWrapper:"dataTables_wrapper form-inline dt-bootstrap",sFilterInput:"form-control input-sm",sLengthSelect:"form-control input-sm",sProcessing:"dataTables_processing panel panel-default"}),rK.ext.renderer.pageButton.bootstrap=function(t,e,i,n,r,a){var o,s,l,h=new rK.Api(t),c=t.oClasses,u=t.oLanguage.oPaginate,d=t.oLanguage.oAria.paginate||{},f=function(e,n){var l,p,g,m,b=function(t){t.preventDefault(),sp(t.currentTarget).hasClass("disabled")||h.page()==t.data.action||h.page(t.data.action).draw("page")};for(l=0,p=n.length;l<p;l++)if(Array.isArray(m=n[l]))f(e,m);else{switch(o="",s="",m){case"ellipsis":o="&#x2026;",s="disabled";break;case"first":o=u.sFirst,s=m+(r>0?"":" disabled");break;case"previous":o=u.sPrevious,s=m+(r>0?"":" disabled");break;case"next":o=u.sNext,s=m+(r<a-1?"":" disabled");break;case"last":o=u.sLast,s=m+(r<a-1?"":" disabled");break;default:o=m+1,s=r===m?"active":""}if(o){var v=-1!==s.indexOf("disabled");g=sp("<li>",{class:c.sPageButton+" "+s,id:0===i&&"string"==typeof m?t.sTableId+"_"+m:null}).append(sp("<a>",{href:v?null:"#","aria-controls":t.sTableId,"aria-disabled":v?"true":null,"aria-label":d[m],role:"link","aria-current":"active"===s?"page":null,"data-dt-idx":m,tabindex:t.iTabIndex}).html(o)).appendTo(e),t.oApi._fnBindAction(g,{action:m},b)}}};try{// Because this approach is destroying and recreating the paging
// elements, focus is lost on the select button which is bad for
// accessibility. So we want to restore focus once the draw has
// completed
l=sp(e).find(document.activeElement).data("dt-idx")}catch(t){}f(sp(e).empty().html('<ul class="pagination"/>').children("ul"),n),void 0!==l&&sp(e).find("[data-dt-idx="+l+"]").trigger("focus")};const sm="https://raw.githubusercontent.com/Dependency-Drift-Tracker/dependency-drift-status/main",sb={};function sv(t){return Number.isInteger(t)?t:t?.toFixed(2)}const sy=(t,e)=>{let i=document.createElement("a");return i.setAttribute("href",t),i.textContent=e,i};async function sx(){let t=await fetch(`${sm}/repositories.txt`);return t.text()}function s_({repository:t,path:e}){return`${t}#${e}`}function sw(t){return t.replaceAll("https://github.com/","").replaceAll(".git","")}async function sS({repository:t,path:e}){let i=s_({repository:t,path:e});sD({repository:t,path:e,line:i}),sT(i),sk(i)}async function sD({repository:t,path:e,line:i}){let n=await sb[i],r=n[n.length-1],a=document.getElementById("title");a.textContent="",a.appendChild(sy(t,sw(i)));let o=document.getElementById("driftSummary");o.textContent=`${sv(r.drift)} libyears`;let s=document.getElementById("pulseSummary");s.textContent=`${sv(r.pulse)} libyears`}function sC(t,e,i,n,r){let a=i.map((t,e)=>new Date(t.date).toLocaleDateString());return new nE(t,{data:{labels:a,datasets:[{type:"line",label:e,data:i.map(t=>sv(t[n])),backgroundColor:`rgba(${r.join()}, 0.2)`,borderColor:`rgba(${r.join()}, 1)`,borderWidth:1,unit:"libyears"}]},options:{plugins:{tooltip:{callbacks:{label:t=>{let e=t.dataset,i=t.dataIndex,n=e.data[i],r=e.label||"",a=e.unit||"";return`${r}: ${n} (${a})`}}}},scales:{y:{position:"left",beginAtZero:!0,suggestedMin:0}}}})}async function sT(t){let n=await sb[t],r=document.getElementById("driftChart"),a=document.getElementById("pulseChart");e&&e.destroy(),i&&i.destroy(),e=sC(r,"Dependency Drift",n,"drift",[0,63,92]),i=sC(a,"Dependency Pulse",n,"pulse",[155,209,132])}async function sk(t){n&&n.destroy();let e=await fetch(`${sm}/data/last-run-${sg(t)}.json`),i=await e.json();n=new rK("#rawResult",{paging:!1,searching:!1,info:!1,columns:[{data:"dependency",title:"Dependency",render:(t,e)=>"display"===e?`<a href="https://www.npmjs.com/package/${t}">${t}</a`:t},{data:"drift",title:"Drift",render:sM},{data:"pulse",title:"Pulse",render:sM}],data:i})}function sM(t,e){return"display"!==e?t:null===t?"":sv(t)}function sA({repository:t,path:e}){let i=document.querySelectorAll("[data-line]");i.forEach(t=>{t.classList.remove("active")});let n=s_({repository:t,path:e}),r=document.querySelector(`[data-line="${n}"]`);r.classList.add("active")}!async function(){let t=(await sx()).split("\n").map(t=>{if(!(""===t.trim()||t.trim().startsWith("#")))return function(t){let[e,i]=t.split("#");return{repository:e,path:i||""}}(t)}).filter(t=>!!t);t.forEach(({repository:t,path:e})=>{let i=s_({repository:t,path:e});sb[i]=fetch(`${sm}/data/history-${sg(i)}.json`).then(t=>t.json())}),function(t){let e=document.getElementById("nav");t.forEach(({repository:t,path:i})=>{let n=document.createElement("li");n.classList.add("nav-item");let r=document.createElement("a");r.classList.add("nav-link","d-flex");let a=s_({repository:t,path:i});r.setAttribute("href",`#${a}`),r.dataset.line=a,r.addEventListener("click",e=>{sS({repository:t,path:i}),sA({repository:t,path:i})});let o=document.createElement("span");o.classList.add("flex-grow-1"),o.textContent=sw(a),r.appendChild(o),sb[a].then(t=>{let e=document.createElement("span");e.classList.add("badge","bg-secondary","align-self-center"),e.textContent=sv(t[t.length-1].drift),r.appendChild(e)}),n.appendChild(r),e.appendChild(n)})}(t);let e=t[0];if(location.hash.length>0){let i=location.hash.slice(1);t.forEach(t=>{let n=s_(t);n===i&&(e=t)})}sS(e),sA(e)}();//# sourceMappingURL=index.665ce362.js.map

//# sourceMappingURL=index.665ce362.js.map
